...
/**
 <!-- globalinfo-start -->
 * Generates data for an np chart.<br>
 * <br>
 * For more information see:<br>
 * QICacros. np Chart Formulas. URL http:&#47;&#47;www.qimacros.com&#47;control-chart-formulas&#47;np-chart-formula&#47;.
 * <br><br>
 <!-- globalinfo-end -->
 *
 <!-- options-start -->
...
public class NPChart
  ...
  public TechnicalInformation getTechnicalInformation() {
    ...
    result.setValue(Field.TITLE, "np Chart Formulas");
    result.setValue(Field.URL, "http://www.qimacros.com/control-chart-formulas/np-chart-formula/");
  ...
  public List<Limits> calculate(Number[] data) {
    ...
    result.add(new Limits(SPCUtils.stats_np(data, m_SampleSize)));
  ...
  public double[] prepare(Number[] data) {
    return StatUtils.toDoubleArray(data);
  }
}
