...
/**
 * Test for MOAModelReader actor.
 *
 * @author fracpete
 * @author adams.core.option.FlowJUnitTestProducer (code generator)
 * @version $Revision$
 */
public class MOAModelReaderTest
   ...
   */
  public MOAModelReaderTest(String name) {
    super(name);
  }
  ...
  public static Test suite() {
    return new TestSuite(MOAModelReaderTest.class);
  }
  ...
  public AbstractActor getActor() {
    ...
    try {
      ...
      tmp2.setFiles(new adams.core.io.PlaceholderFile[]{(adams.core.io.PlaceholderFile) argOption.valueOf("${TMP}/naivebayes.model")});

      tmp1[0] = tmp2;
      adams.flow.transformer.MOAModelReader tmp4 = new adams.flow.transformer.MOAModelReader();
      tmp1[1] = tmp4;
