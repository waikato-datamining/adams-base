...
/**
 * Handler for {@link adams.data.gps.GPSDecimalDegrees} objects.
 * 
...
public class GPSDecimalDegrees
   ...
   */
  @Override
  public adams.data.gps.GPSDecimalDegrees parse(String s) {
    return new adams.data.gps.GPSDecimalDegrees(s, m_Swapped);
  }
  ...
  public String format(adams.data.gps.AbstractGPS obj) {
    if (obj instanceof adams.data.gps.GPSDecimalDegrees)
      return obj.toString();
    else
      return new adams.data.gps.GPSDecimalDegrees(obj).toString();
  }
}
