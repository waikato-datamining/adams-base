...
/*
 * ArcInfoASCIIGridReaderTest.java
...
/**
 * Tests the adams.data.io.input.ArcInfoASCIIGridReader class. Run from commandline with: <br><br>
 * java adams.data.io.input.ArcInfoASCIIGridReader
 *
 * @author  fracpete (fracpete at waikato dot ac dot nz)
 * @version $Revision$
 */
public class ArcInfoASCIIGridReaderTest
   ...
   */
  public ArcInfoASCIIGridReaderTest(String name) {
    super(name);
  }
