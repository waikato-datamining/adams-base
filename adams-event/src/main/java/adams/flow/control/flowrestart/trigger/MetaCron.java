...
public class MetaCron
  ...
  public static class CronJob
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
      ...
      result = null;
      owner = (MetaCron) context.getJobDetail().getJobDataMap().get(KEY_OWNER);
   ...
   *
   * @return		the flow, null if none yet set
   */
  public Flow getFlow() {
    return m_Flow;
  }
  ...
  public String getQuickInfo() {
    ...
    result = QuickInfoHelper.toString(this, "schedule", m_Schedule.getValue(), "schedule: ");
    result += QuickInfoHelper.toString(this, "trigger", m_Schedule.getValue(), ", trigger: ");
  ...
  protected String doStart(Flow flow) {
	...
	.withSchedule(sBuilder);
      ...
      if (isLoggingEnabled())
	getLogger().info("First execution of base trigger: " + first);
      m_Scheduler.start();
    }
    catch (Exception e) {
