...
public class EventReferenceEditor
  ...
  public String getJavaInitializationString() {
    ...
    result = "new " + EventReference.class.getName() + "(\"" + Utils.backQuoteChars(getValue().toString()) + "\")";
  ...
  protected boolean updateValue(TreePath path) {
	...
	event = (ActorPathNode) node;
	if (event.hasClassname()) {
	  m_TextValue.setText(event.getLabel());
	  result = true;
	}
      }
    }
  ...
  protected JComponent createCustomEditor() {
    ...
    panelTree.add(new JLabel("Select event:"), BorderLayout.NORTH);
  ...
  protected boolean isValid(String s) {
    return ((EventReference) getValue()).isValid(s);
  }
  ...
  protected boolean isUnchanged(String s) {
    return s.equals(((EventReference) getValue()).getValue());
  }
  ...
  protected void initForDisplay() {
    ...
    m_TextValue.setToolTipText(((EventReference) getValue()).getTipText());

    m_Tree.setFlowTree(FlowHelper.getTree(m_CustomEditor));
    m_Tree.setItems(findEvents());
    m_Tree.expandAll();
