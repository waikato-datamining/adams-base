...
/*
 * AbstractCenteredMovingAverage.java
...
import adams.data.utils.CenteredMovingAverage;
...
/**
 * Abstract ancestor for Centered Moving Average filters.
 *
 * @author  fracpete (fracpete at waikato dot ac dot nz)
 * @param <T> the type of data to process
 */
public abstract class AbstractCenteredMovingAverage<T extends DataContainer>
  ...
  public TechnicalInformation getTechnicalInformation() {
    return CenteredMovingAverage.getTechnicalInformation();
  }
  ...
  public String windowSizeTipText() {
    return "The window size to use (uneven number).";
  }
