...
/**
 * Ancestor for Centered Moving Average based baseline correction schemes.
 *
...
public abstract class AbstractCenteredMovingAverageBased<T extends DataContainer>
  ...
  /** the filter to use. */
  protected AbstractCenteredMovingAverage m_Filter;
  ...
  public String globalInfo() {
    return
      "A baseline correction scheme that uses CenteredMovingAverage smoothing to determine the baseline.\n\n"
   ...
   * @return		the filter
   */
  protected abstract AbstractCenteredMovingAverage getFilter();
