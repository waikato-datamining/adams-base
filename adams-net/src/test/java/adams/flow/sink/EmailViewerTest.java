...
/**
 * Test for EmailViewer actor.
 *
 * @author fracpete
 * @author adams.core.option.FlowJUnitTestProducer (code generator)
 * @version $Revision$
 */
public class EmailViewerTest
   ...
   */
  public EmailViewerTest(String name) {
    super(name);
  }
  ...
  public static Test suite() {
    return new TestSuite(EmailViewerTest.class);
  }
