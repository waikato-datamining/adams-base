...
public class URLEncode
  ...
  public String globalInfo() {
    return "Encodes the string to make it usable within a URL (uses " + Utils.classToString(URLEncoder.class) + ").";
  }
  ...
  protected Object doConvert() throws Exception {
    return URLEncoder.encode((String) m_Input, m_Encoding.stringValue());
  }
}
