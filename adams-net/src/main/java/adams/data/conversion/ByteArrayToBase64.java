...
public class ByteArrayToBase64
  ...
  public String globalInfo() {
    return "Encodes a byte array as base64 string.";
  }
  ...
  protected Object doConvert() throws Exception {
    switch (m_Type) {
      ...
      case BASIC:
        return new String(Base64.getEncoder().encode((byte[]) m_Input));
      case URL_FILENAME_SAFE:
        return new String(Base64.getUrlEncoder().encode((byte[]) m_Input));
      case MIME:
        return new String(Base64.getMimeEncoder().encode((byte[]) m_Input));
      default:
