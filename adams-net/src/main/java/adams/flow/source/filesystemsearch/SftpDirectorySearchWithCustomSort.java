...
/**
 * SftpDirectorySearchWithCustomSort.java
 ...
 * @version $Revision$
 */
public class SftpDirectorySearchWithCustomSort
  ...
  public String globalInfo() {
    return "Searches only for directories, but uses a regular expression to reassemble the name and perform the sorting (SFTP).";
  }
