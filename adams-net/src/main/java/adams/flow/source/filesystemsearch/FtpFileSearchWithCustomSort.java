...
/**
 * FtpFileSearchWithCustomSort.java
 ...
 * @version $Revision$
 */
public class FtpFileSearchWithCustomSort
  extends FtpDirectorySearchWithCustomSort {
  ...
  public String globalInfo() {
    return "Searches only for files, but uses a regular expression to reassemble the name and perform the sorting (FTP).";
  }
