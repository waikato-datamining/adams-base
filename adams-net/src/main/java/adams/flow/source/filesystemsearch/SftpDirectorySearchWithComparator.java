...
/**
 * SftpDirectorySearchWithComparator.java
 ...
 * @version $Revision$
 */
public class SftpDirectorySearchWithComparator
  ...
  public String globalInfo() {
    return "Searches only for directories, but uses the comparator for sorting the directories (SFTP).";
  }
