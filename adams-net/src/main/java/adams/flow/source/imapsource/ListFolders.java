...
public class ListFolders
  extends AbstractIMAPOperation<String[]> {
   ...
   */
  @Override
  protected String[] doExecute(IMAPConnection conn, MessageCollection errors) {
    return conn.getImapSession().getAllFolders();
  }
}
