...
/**
 <!-- globalinfo-start -->
 * Downloads a remote file and forwards the local file name via secure FTP (SFTP).<br/>
 * <br/>
 ...
 * &nbsp;&nbsp;&nbsp;The SFTP directory to download the file from.
 * &nbsp;&nbsp;&nbsp;default: &#47;pub
 * </pre>
 * 
...
public class SFTPGet
  ...
  public String globalInfo() {
    return 
	"Downloads a remote file and forwards the local file name via secure "
      + "FTP (SFTP).\n\n"
