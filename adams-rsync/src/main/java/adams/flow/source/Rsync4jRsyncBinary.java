 ...
 * @version $Revision$
 */
public class Rsync4jRsyncBinary
  ...
  protected String doExecute() {
    ...
    result = null;
    try {
      m_OutputToken = new Token(Binaries.rsyncBinary());
    }
    catch (Exception e) {
      result = handleException("Failed to determine rsync binary!", e);
    }
