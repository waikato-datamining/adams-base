...
/**
 * Test for PDFNewDocument actor.
 *
 * @author fracpete
 * @author adams.core.option.FlowJUnitTestProducer (code generator)
 * @version $Revision$
 */
public class PDFNewDocumentTest
   ...
   */
  public PDFNewDocumentTest(String name) {
    super(name);
  }
  ...
  public static Test suite() {
    return new TestSuite(PDFNewDocumentTest.class);
  }
