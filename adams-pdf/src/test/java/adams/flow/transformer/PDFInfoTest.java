...
public class PDFInfoTest
   ...
   */
  public PDFInfoTest(String name) {
    super(name);
  }
  ...
  public static Test suite() {
    return new TestSuite(PDFInfoTest.class);
  }
  ...
  public AbstractActor getActor() {
    ...
    try {
      ...
      files.add((PlaceholderFile) argOption.valueOf("${TMP}/multiple_pages.pdf"));
