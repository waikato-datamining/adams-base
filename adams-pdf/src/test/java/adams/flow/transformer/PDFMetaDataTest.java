...
public class PDFMetaDataTest
   ...
   */
  public PDFMetaDataTest(String name) {
    super(name);
  }
  ...
  public static Test suite() {
    return new TestSuite(PDFMetaDataTest.class);
  }
  ...
  public Actor getActor() {
    ...
    try {
      ...
      files3[0] = (adams.core.io.PlaceholderFile) argOption.valueOf("${TMP}/pdf_with_images.pdf");
      filesupplier2.setFiles(files3);
      actors1[0] = filesupplier2;

      // Flow.PDFMetaData
      adams.flow.transformer.PDFMetaData pdfmetadata4 = new adams.flow.transformer.PDFMetaData();
      actors1[1] = pdfmetadata4;
      ...
      dumpfile5.setOutputFile((adams.core.io.PlaceholderFile) argOption.valueOf("${TMP}/dumpfile.csv"));
      actors1[2] = dumpfile5;
