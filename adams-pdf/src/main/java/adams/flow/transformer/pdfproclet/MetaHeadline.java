 ...
 * </pre>
 * 
 * <pre>-proclet &lt;adams.flow.transformer.pdfproclet.PdfProclet&gt; (property: proclet)
 * &nbsp;&nbsp;&nbsp;The base PDF proclet to use.
 * &nbsp;&nbsp;&nbsp;default: adams.flow.transformer.pdfproclet.PlainText
 * </pre>
 * 
 ...
 * @version $Revision$
 */
public class MetaHeadline
  extends AbstractMetaPdfProclet
  ...
  public String globalInfo() {
    return "Adds a simple headline before applying the base proclet.";
  }
  ...
  protected boolean doProcess(PDFGenerator generator, File file) throws Exception {
    ...
    result = addElement(generator, new Paragraph(m_Headline.getValue(), m_FontHeadline.toFont(m_ColorHeadline)));
    if (result)
      result = m_Proclet.process(generator, file);
  ...
  protected boolean doProcess(PDFGenerator generator, Object obj) throws Exception {
    ...
    result = addElement(generator, new Paragraph(m_Headline.getValue(), m_FontHeadline.toFont(m_ColorHeadline)));
    if (result && m_Proclet.canProcess(generator, obj))
      result = m_Proclet.process(generator, obj);
