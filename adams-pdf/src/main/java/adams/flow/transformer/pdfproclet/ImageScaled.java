 ...
 * &nbsp;&nbsp;&nbsp;The scaling factor for the image (1=100%).
 * &nbsp;&nbsp;&nbsp;default: 1.0
 * &nbsp;&nbsp;&nbsp;minimum: 0.0
 * </pre>
 *
...
public class ImageScaled
  ...
  /**
   * Sets the scale factor (1=100%) for images based on the page size.
   *
  ...
  /**
   * Returns the scale factor (1=100%) for images based on the page size.
   *
  ...
  public String scaleTipText() {
    return "The scaling factor for the image (1=100%).";
  }
