...
/**
 * Test for CopyCallableSink actor.
 *
 * @author fracpete
 * @author adams.core.option.FlowJUnitTestProducer (code generator)
 * @version $Revision$
 */
public class CopyCallableSinkTest
   ...
   */
  public CopyCallableSinkTest(String name) {
    super(name);
  }
  ...
  public Actor getActor() {
    ...
    try {
      ...
      tmp13[0] = (adams.core.base.BaseString) argOption.valueOf("1");
      tmp13[1] = (adams.core.base.BaseString) argOption.valueOf("2");
      tmp13[2] = (adams.core.base.BaseString) argOption.valueOf("3");
      tmp13[3] = (adams.core.base.BaseString) argOption.valueOf("4");
      tmp13[4] = (adams.core.base.BaseString) argOption.valueOf("5");
      ...
      tmp11[2] = tmp17;
      adams.flow.sink.CopyCallableSink tmp19 = new adams.flow.sink.CopyCallableSink();
      ...
      tmp25[0] = (adams.core.base.BaseString) argOption.valueOf("1");
      tmp25[1] = (adams.core.base.BaseString) argOption.valueOf("2");
      tmp25[2] = (adams.core.base.BaseString) argOption.valueOf("3");
      tmp25[3] = (adams.core.base.BaseString) argOption.valueOf("4");
      tmp25[4] = (adams.core.base.BaseString) argOption.valueOf("5");
      tmp24.setStrings(tmp25);
      ...
      tmp23[2] = tmp29;
      adams.flow.sink.CopyCallableSink tmp31 = new adams.flow.sink.CopyCallableSink();
      argOption = (AbstractArgumentOption) tmp31.getOptionManager().findByProperty("callableName");
      tmp31.setCallableName((adams.flow.core.CallableActorReference) argOption.valueOf("DumpFile"));
