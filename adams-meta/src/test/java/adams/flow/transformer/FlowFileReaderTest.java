...
public class FlowFileReaderTest
  ...
  public AbstractActor getActor() {
    ...
    try {
      ...
      flowfilereader.setCustomReader(defaultflowreader);
      ...
      adams.core.option.JenericCommandLineHandler jenericcommandlinehandler = new adams.core.option.JenericCommandLineHandler();
      jenericcommandlinehandler.setOptions(arrayproducer, OptionUtils.splitOptions("-logging-level OFF -output-variable-values false"));
      optionproducer.setProducer(arrayproducer);
