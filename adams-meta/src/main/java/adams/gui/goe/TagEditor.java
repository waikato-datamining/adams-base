...
import adams.core.option.parsing.TagParsing;
...
/**
 * Editor specifically designed for entering tags (key/value pairs).
 *
...
public class TagEditor
  ...
  public String toCustomStringRepresentation(Object obj) {
    return TagParsing.toString(null, obj);
  }
  ...
  public Object fromCustomStringRepresentation(String str) {
    return TagParsing.valueOf(null, str);
  }
  ...
  public Object[] getSelectedObjects(Container parent) {
    ...
    result = new Tag[lines.size()];
    for (i = 0; i < lines.size(); i++)
      result[i] = (Tag) parse(lines.get(i));
