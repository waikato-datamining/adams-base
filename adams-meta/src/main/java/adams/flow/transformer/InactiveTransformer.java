...
/**
 <!-- globalinfo-start -->
 * Encapsulates a sequence of inactive actors. The first actor must accept input and the last one must produce output.<br>
 ...
 */
public class InactiveTransformer
  extends SubProcess
  ...
  public String globalInfo() {
    return
      "Encapsulates a sequence of inactive actors. The first actor must accept "
