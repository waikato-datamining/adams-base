 ...
 * @version $Revision$
 */
public class IncludeExternalSource
  ...
  public String globalInfo() {
    return "Includes an external source.";
  }
  ...
  protected String checkExternalActor(AbstractActor actor) {
    if (!ActorUtils.isSource(actor))
      return "External actor (" + actor.getClass().getName() + ") is not a source!";
    return null;
  }
