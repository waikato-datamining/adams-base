...
/**
 <!-- globalinfo-start -->
 * Generates data using a Pyro4 call<br>
 * <br>
 ...
 * </pre>
 *
 * <pre>-call &lt;adams.flow.source.pyrosource.AbstractPyroSource&gt; (property: call)
 * &nbsp;&nbsp;&nbsp;The Pyro call to use for transforming the data.
 * &nbsp;&nbsp;&nbsp;default: adams.flow.source.pyrosource.Null
 * </pre>
 *
 <!-- options-end -->
 *
...
public class PyroSource
  ...
  public String globalInfo() {
    return "Generates data using a Pyro4 call\n\n"
   ...
   */
  public void setCall(AbstractPyroSource value) {
    m_Call = value;
    reset();
  }
   ...
   * @return 		the call
   */
  public AbstractPyroSource getCall() {
    return m_Call;
  }
  ...
  protected String doExecute() {
    ...
    if ((result == null) && m_Call.hasPendingOutput())
      m_OutputToken = new Token(m_Call.output());
    m_Call.cleanUp();
