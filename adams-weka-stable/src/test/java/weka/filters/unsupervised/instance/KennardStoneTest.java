...
/**
 * Tests KennardStone. Run from the command line with: <br><br>
 * java weka.filters.unsupervised.instance.KennardStoneTest
 *
...
public class KennardStoneTest
  ...
  /**
   * Creates a default KennardStone.
   *
  ...
  protected void performTest() {
    ...
    assertEquals(30, result.numInstances());
  }
