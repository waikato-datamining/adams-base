...
/**
 * Tests SimpleArffLoader/SimpleArffSaver. Run from the command line with:<br><br>
 * java weka.core.converters.SimpleArffTest
 *
 * @author FracPete (fracpete at waikato dot ac dot nz)
 * @version $Revision$
 */
public class SimpleArffTest
  extends AbstractAdamsFileConverterTest {

  /**
   * Constructs the <code>SimpleArffTest</code>.
   *
   * @param name the name of the test class
   */
  public SimpleArffTest(String name) {
    super(name);  
  }
