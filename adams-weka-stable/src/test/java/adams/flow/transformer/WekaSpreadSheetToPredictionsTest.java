...
/*
 * WekaSpreadSheetToPredictionsTest.java
...
/**
 * Test for WekaSpreadSheetToPredictions actor.
 *
 * @author fracpete
 * @author adams.core.option.FlowJUnitTestProducer (code generator)
 * @version $Revision$
 */
public class WekaSpreadSheetToPredictionsTest
   ...
   */
  public WekaSpreadSheetToPredictionsTest(String name) {
    super(name);
  }
  ...
  protected void setUp() throws Exception {
    ...
    m_TestHelper.copyResourceToTmp("bodyfat_predictions.csv");
  ...
  protected void tearDown() throws Exception {
    m_TestHelper.deleteFileFromTmp("bodyfat_predictions.csv");
    m_TestHelper.deleteFileFromTmp("dumpfile.txt");
  ...
  public static Test suite() {
    return new TestSuite(WekaSpreadSheetToPredictionsTest.class);
  }
  ...
  public AbstractActor getActor() {
    ...
    try {
      ...
      files.add((PlaceholderFile) argOption.valueOf("${TMP}/bodyfat_predictions.csv"));
