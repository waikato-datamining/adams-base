...
/**
 * Tests the WekaClassifierSetup actor.
 *
 * @author  fracpete (fracpete at waikato dot ac dot nz)
 * @version $Revision$
 */
public class WekaClassifierSetupTest
   ...
   */
  public WekaClassifierSetupTest(String name) {
    super(name);
  }
  ...
  public static Test suite() {
    return new TestSuite(WekaClassifierSetupTest.class);
  }
