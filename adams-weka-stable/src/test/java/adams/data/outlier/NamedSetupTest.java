...
/**
 * Test class for the NamedSetup outlier detector. Run from the command line with: <br><br>
 * java adams.data.outlier.NamedSetupTest
 *
...
public class NamedSetupTest
  ...
  protected AbstractOutlierDetector[] getRegressionSetups() {
    ...
    result[0].setSetup(new adams.core.NamedSetup("outlier_passthrough"));
