...
/**
 * Test class for the Excluded outlier detector. Run from the command line with: <br><br>
 * java adams.data.outlier.ExcludedTest
 *
...
public class ExcludedTest
  ...
  protected AbstractOutlierDetector[] getRegressionSetups() {
    ...
    result = new Excluded[1];

    result[0] = new Excluded();
