...
public class RemoveByNameTest
  ...
  protected AbstractReportFilter[] getRegressionSetups() {
    ...
    result    = new RemoveByName[3];
    result[0] = new RemoveByName();
    result[1] = new RemoveByName();
    result[1].setRegExp(new BaseRegExp(".*Name"));
    result[2] = new RemoveByName();
    result[2].setRegExp(new BaseRegExp(".*Name"));
