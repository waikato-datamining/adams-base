...
/*
 * JSONSpreadSheetWriterTest.java
...
/**
 * Tests the adams.data.io.input.JSONSpreadSheetWriter class. Run from commandline with: <br><br>
 * java adams.data.io.input.JSONSpreadSheetWriter
 *
 * @author  fracpete (fracpete at waikato dot ac dot nz)
 * @version $Revision$
 */
public class JSONSpreadSheetWriterTest
   ...
   */
  public JSONSpreadSheetWriterTest(String name) {
    super(name);
  }
  ...
  public static Test suite() {
    return new TestSuite(JSONSpreadSheetWriterTest.class);
  }
