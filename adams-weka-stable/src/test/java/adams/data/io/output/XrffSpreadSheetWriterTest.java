...
/*
 * XrffSpreadSheetWriterTest.java
...
/**
 * Tests the adams.data.io.input.XrffSpreadSheetWriter class. Run from commandline with: <br><br>
 * java adams.data.io.input.XrffSpreadSheetWriter
 *
 * @author  fracpete (fracpete at waikato dot ac dot nz)
 * @version $Revision$
 */
public class XrffSpreadSheetWriterTest
   ...
   */
  public XrffSpreadSheetWriterTest(String name) {
    super(name);
  }
  ...
  public static Test suite() {
    return new TestSuite(XrffSpreadSheetWriterTest.class);
  }
