...
import adams.data.weka.rowfinder.MultiRowFinder.Combination;
...
public class MultiRowFinderTest
  ...
  protected RowFinder[] getRegressionSetups() {
    ...
    result[1].setFinders(new RowFinder[]{new NullFinder(), new NullFinder()});

    result[2] = new MultiRowFinder();
    result[2].setCombination(Combination.INTERSECT);
    result[2].setFinders(new RowFinder[]{new NullFinder(), new NullFinder()});
