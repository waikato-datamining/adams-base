...
/**
 * WekaInvestigatorShortcutsDefinition.java
 ...
 * @version $Revision$
 */
public class WekaInvestigatorShortcutsDefinition
  ...
  /** the key as constant. */
  public final static String KEY = "weka investigator shortcuts";
  ...
  public String getFile() {
    return InvestigatorPanel.FILENAME_SHORTCUTS;
  }
  ...
  public void update(AbstractEnvironment env) {
    add(env, Project.NAME + "/gui/tools/wekainvestigator", new String[0]);
  }
}
