...
public abstract class M5Base2 
  ...
  public double classifyInstance(Instance inst) throws Exception {
    ...
    if (!m_generateRules) {
      temp = (Rule2) m_ruleSet.elementAt(0);
    ...
    for (i = 0; i < m_ruleSet.size(); i++) {
      cont = false;
      temp = (Rule2) m_ruleSet.elementAt(i);
  ...
  public String toString() {
	...
	temp = (Rule2) m_ruleSet.elementAt(j);
  ...
  public double measureNumRules() {
    ...
    return ((Rule2)m_ruleSet.elementAt(0)).m_topOfTree.numberOfLinearModels();
  }

  public RuleNode2 getM5RootNode() {
    Rule2 temp = (Rule2) m_ruleSet.elementAt(0);
