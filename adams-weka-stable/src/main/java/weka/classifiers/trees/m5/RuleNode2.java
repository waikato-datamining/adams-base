...
public class RuleNode2 
   ...
   */
  public RuleNode2(double globalDev, double globalAbsDev, RuleNode2 parent) {
    m_nodeModel = null;
    m_right = null;
    m_left = null;
    m_parent = parent;
  ...
  public void buildClassifier(Instances data) throws Exception {
	...
	|| (Rule2.stdDev(m_classIndex, m_instances) 
  ...
  public void split() throws Exception {
	...
	m_left = new RuleNode2(m_globalDeviation, m_globalAbsDeviation, this);
	...
	m_right = new RuleNode2(m_globalDeviation, m_globalAbsDeviation, this);
   ...
   */
  public void findBestLeaf(double[] maxCoverage, RuleNode2[] bestLeaf) {
    if (!m_isLeaf) {
      if (m_left != null) {
