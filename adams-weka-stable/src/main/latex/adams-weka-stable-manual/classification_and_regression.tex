...
sources\footnote{adams-weka-stable-stable-crossvalidate\_classifier\_multiple\_datasets.flow},
...
In this example\footnote{adams-weka-stable-stable-load\_dataset.flow} we let the
...
data. The flow\footnote{adams-weka-stable-stable-data\_generator.flow} depicted in Figure
...
\ref{basic-building_model1-output})\footnote{adams-weka-stable-stable-build\_classifier-output\_only\_model.flow}.
...
there\footnote{adams-weka-stable-stable-build\_classifier-save\_model.flow}.
...
flow\footnote{adams-weka-stable-stable-filter\_data.flow} cross-validates
...
flow\footnote{adams-weka-stable-stable-crossvalidate\_classifier.flow} with simple
...
after\footnote{adams-weka-stable-stable-crossvalidate\_classifier\_setups\_from\_text\_file.flow}.
...
showing the
results\footnote{adams-weka-stable-stable-build\_classifier\_evaluate\_on\_testset.flow}. The
...
process\footnote{adams-weka-stable-stable-evaluate\_classifier\_randomsplit.flow}. For
...
\ref{basic-traintestseteval-output} display the flow\footnote{adams-weka-stable-stable-assemble\_traintestset\_container\_and\_evaluate\_classifier.flow}
...
largest\footnote{adams-weka-stable-stable-accumulated\_error\_display.flow}. The Figures
...
flow\footnote{adams-weka-stable-stable-classifying\_data.flow} in Figure
...
condition).\footnote{adams-weka-stable-stable-build\_classifier\_incrementally.flow}
...
10 instances.\footnote{adams-weka-stable-stable-classifier\_learning\_curve.flow}
...
\begin{tight_itemize}
  \item experiment generation -- \textit{adams-weka-stable-stable-experiment\_generation.flow}
  \item execution and evaluation -- \textit{adams-weka-stable-stable-experiment.flow}
\end{tight_itemize}

For using the ADAMS framework, check out these:
\begin{tight_itemize}
  \item \textit{adams-weka-stable-stable-experiment2.flow}
  \item \textit{adams-weka-stable-stable-experiment3.flow}
\end{tight_itemize}

\subsection{Optimization}
The following flows demonstrate some of the optimization capabilities:
\begin{tight_itemize}
  \item setup generators -- \textit{adams-weka-stable-stable-classifier\_setup\_generation.flow},
  \item ranker -- \textit{adams-weka-stable-stable-classifier\_setup\_ranking.flow},
  \item optimizer -- \textit{adams-weka-stable-stable-classifier\_optimizer.flow}
\end{tight_itemize}
...
classifier on a pre-processed dataset\footnote{adams-weka-stable-stable-crossvalidate\_classifier-display\_provenance.flow}.
...
stored).\footnote{adams-weka-stable-stable-extract\_pls\_matrix.flow}
