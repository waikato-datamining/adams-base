...
/**
 * Tests the SpreadSheetToString conversion.
 *
...
public class SpreadSheetToStringTest
  ...
  protected Conversion[] getRegressionSetups() {
    SpreadSheetToString[]	result;

    result    = new SpreadSheetToString[1];
    result[0] = new SpreadSheetToString();
