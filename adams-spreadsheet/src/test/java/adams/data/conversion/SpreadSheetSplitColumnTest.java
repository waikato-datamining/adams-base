 ...
 * @version $Revision$
 */
public class SpreadSheetSplitColumnTest
   ...
   */
  public SpreadSheetSplitColumnTest(String name) {
    super(name);
  }
  ...
  protected Conversion[] getRegressionSetups() {
    SpreadSheetSplitColumn[]	result;

    result    = new SpreadSheetSplitColumn[2];
  ...
  public static Test suite() {
    return new TestSuite(SpreadSheetSplitColumnTest.class);
  }
