...
/**
 * Tests the SpreadSheetToJson conversion.
 *
...
public class SpreadSheetToJsonTest
   ...
   */
  public SpreadSheetToJsonTest(String name) {
    super(name);
  }
  ...
  protected Conversion[] getRegressionSetups() {
    SpreadSheetToJson[]	result;

    result    = new SpreadSheetToJson[1];
    result[0] = new SpreadSheetToJson();
  ...
  public static Test suite() {
    return new TestSuite(SpreadSheetToJsonTest.class);
  }
