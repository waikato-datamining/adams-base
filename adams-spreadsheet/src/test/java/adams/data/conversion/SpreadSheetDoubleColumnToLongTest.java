...
/**
 * SpreadSheetDoubleColumnToLongTest.java
...
/**
 * Tests the SpreadSheetDoubleColumnToLong conversion.
 *
 * @author  fracpete (fracpete at waikato dot ac dot nz)
 * @version $Revision$
 */
public class SpreadSheetDoubleColumnToLongTest
   ...
   */
  public SpreadSheetDoubleColumnToLongTest(String name) {
    super(name);
  }
  ...
  protected Conversion[] getRegressionSetups() {
    SpreadSheetDoubleColumnToLong[]	result;

    result    = new SpreadSheetDoubleColumnToLong[2];
    result[0] = new SpreadSheetDoubleColumnToLong();
    result[0].setColumn(new SpreadSheetColumnIndex("2"));
    result[1] = new SpreadSheetDoubleColumnToLong();
  ...
  public static Test suite() {
    return new TestSuite(SpreadSheetDoubleColumnToLongTest.class);
  }
