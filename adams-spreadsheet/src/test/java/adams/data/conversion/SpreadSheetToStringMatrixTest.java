...
/**
 * Tests the SpreadSheetToStringMatrix conversion.
 *
 * @author  fracpete (fracpete at waikato dot ac dot nz)
 * @version $Revision: 6556 $
 */
public class SpreadSheetToStringMatrixTest
   ...
   */
  public SpreadSheetToStringMatrixTest(String name) {
    super(name);
  }
  ...
  public static Test suite() {
    return new TestSuite(SpreadSheetToStringMatrixTest.class);
  }
