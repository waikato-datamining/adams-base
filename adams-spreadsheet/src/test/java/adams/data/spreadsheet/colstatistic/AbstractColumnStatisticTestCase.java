...
public abstract class AbstractColumnStatisticTestCase
  ...
  public void testRegression() {
    ...
    int				i;
    String[]			input;
    AbstractColumnStatistic[]	setups;
    AbstractColumnStatistic	current;
    int[]			columns;
    String[]			output;
    TmpFile[]			outputFiles;
    ...
    for (i = 0; i < input.length; i++) {
      ...
      current = (AbstractColumnStatistic) OptionUtils.shallowCopy(setups[i]);
