...
/**
 * AbstractRowStatisticTestCase.java
...
/**
 * Ancestor for row stats test cases.
 *
 * @author  fracpete (fracpete at waikato dot ac dot nz)
 * @version $Revision: 9765 $
 */
public abstract class AbstractRowStatisticTestCase
   ...
   */
  public AbstractRowStatisticTestCase(String name) {
    super(name);
  }
  ...
  protected AbstractTestHelper newTestHelper() {
    return new TestHelper(this, "adams/data/spreadsheet/rowstatistic/data");
  }
