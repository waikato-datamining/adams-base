...
/**
 * AbstractSpreadSheetFilterTestCase.java
...
public abstract class AbstractSpreadSheetFilterTestCase
  ...
  protected AbstractTestHelper newTestHelper() {
    return new TestHelper(this, "adams/data/spreadsheet/filter/data");
  }
  ...
  public void testRegression() {
    ...
    int				i;
    String[]			input;
    SpreadSheetFilter[]		setups;
    SpreadSheetFilter		current;
    String[]			output;
    TmpFile[]			outputFiles;
    ...
    for (i = 0; i < input.length; i++) {
      ...
      current = (SpreadSheetFilter) OptionUtils.shallowCopy(setups[i]);
