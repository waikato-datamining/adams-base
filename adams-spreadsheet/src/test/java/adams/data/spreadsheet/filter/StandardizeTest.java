...
/**
 * Tests the adams.data.spreadsheet.filter.Standardize class. Run from commandline with: <br><br>
 * java adams.data.spreadsheet.filter.StandardizeTest
 *
...
public class StandardizeTest
  ...
  protected SpreadSheetFilter[] getRegressionSetups() {
    ...
    result    = new Standardize[2];
    result[0] = new Standardize();
    result[1] = new Standardize();
