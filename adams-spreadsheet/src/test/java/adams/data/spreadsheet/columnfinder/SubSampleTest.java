...
/**
 * Test class for the SubSample finder.
 *
...
public class SubSampleTest
   ...
   */
  public SubSampleTest(String name) {
    super(name);
  }
  ...
  protected ColumnFinder[] getRegressionSetups() {
    ...
    result = new SubSample[3];

    result[0] = new SubSample();
    result[1] = new SubSample();
    result[1].setSize(0.2);
    result[2] = new SubSample();
    result[2].setSize(5);
