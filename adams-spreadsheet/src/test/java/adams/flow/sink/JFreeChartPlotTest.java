...
public class JFreeChartPlotTest
   ...
   */
  public JFreeChartPlotTest(String name) {
    super(name);
  }
  ...
  public static Test suite() {
    return new TestSuite(JFreeChartPlotTest.class);
  }
  ...
  public AbstractActor getActor() {
    ...
    try {
      ...
      argOption = (AbstractArgumentOption) jfreechartplot.getOptionManager().findByProperty("width");
      jfreechartplot.setWidth((Integer) argOption.valueOf("1200"));
