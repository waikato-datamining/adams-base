...
/*
 * SpreadSheetRemoveColumnTest.java
...
/**
 * Test for SpreadSheetRemoveColumn actor.
 *
 * @author fracpete
 * @author adams.core.option.FlowJUnitTestProducer (code generator)
 * @version $Revision$
 */
public class SpreadSheetRemoveColumnTest
   ...
   */
  public SpreadSheetRemoveColumnTest(String name) {
    super(name);
  }
  ...
  public static Test suite() {
    return new TestSuite(SpreadSheetRemoveColumnTest.class);
  }
  ...
  public Actor getActor() {
    ...
    try {
      ...
      tmp1[1] = tmp4;
      // Flow.SpreadSheetRemoveColumn
      adams.flow.transformer.SpreadSheetRemoveColumn tmp7 = new adams.flow.transformer.SpreadSheetRemoveColumn();
      argOption = (AbstractArgumentOption) tmp7.getOptionManager().findByProperty("position");
      tmp7.setPosition((adams.data.spreadsheet.SpreadSheetColumnRange) argOption.valueOf("2"));
