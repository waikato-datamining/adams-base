...
/*
 * SpreadSheetCellFinderTest.java
...
/**
 * Test for SpreadSheetCellFinder actor.
 *
 * @author fracpete
...
public class SpreadSheetCellFinderTest
  ...
  public AbstractActor getActor() {
    ...
    try {
      ...
      bynumericvalue.setMinimum((Double) argOption.valueOf("50.0"));
      ...
      bynumericvalue.setMaximum((Double) argOption.valueOf("NaN"));
      ...
      spreadsheetcellfinder.setFinder(rowfinderrange);
