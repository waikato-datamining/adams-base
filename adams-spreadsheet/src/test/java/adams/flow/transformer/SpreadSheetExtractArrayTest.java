...
/*
 * SpreadSheetExtractArrayTest.java
...
import adams.flow.transformer.SpreadSheetExtractArray.ExtractionType;
...
/**
 * Test for SpreadSheetExtractArray actor.
 *
 * @author fracpete
...
public class SpreadSheetExtractArrayTest
  ...
  public AbstractActor getActor() {
    ...
    try {
      ...
      spreadsheetextractarray.setType((ExtractionType) argOption.valueOf("ROW"));
