...
/**
 * Test for SpreadSheetRowFilter actor.
 *
 * @author fracpete
 * @author adams.core.option.FlowJUnitTestProducer (code generator)
 * @version $Revision$
 */
public class SpreadSheetRowFilterTest
   ...
   */
  public SpreadSheetRowFilterTest(String name) {
    super(name);
  }
  ...
  public static Test suite() {
    return new TestSuite(SpreadSheetRowFilterTest.class);
  }
  ...
  public AbstractActor getActor() {
    ...
    try {
      ...
      adams.flow.transformer.SpreadSheetRowFilter tmp7 = new adams.flow.transformer.SpreadSheetRowFilter();
