...
/*
 * SpreadSheetSetHeaderCellTest.java
...
/**
 * Test for SpreadSheetSetHeaderCell actor.
 *
 * @author fracpete
 * @author adams.core.option.FlowJUnitTestProducer (code generator)
 * @version $Revision$
 */
public class SpreadSheetSetHeaderCellTest
   ...
   */
  public SpreadSheetSetHeaderCellTest(String name) {
    super(name);
  }
  ...
  public static Test suite() {
    return new TestSuite(SpreadSheetSetHeaderCellTest.class);
  }
  ...
  public AbstractActor getActor() {
    ...
    try {
      ...
      // Flow.SpreadSheetSetHeaderCell
      adams.flow.transformer.SpreadSheetSetHeaderCell spreadsheetsetheadercell7 = new adams.flow.transformer.SpreadSheetSetHeaderCell();
      argOption = (AbstractArgumentOption) spreadsheetsetheadercell7.getOptionManager().findByProperty("value");
      spreadsheetsetheadercell7.setValue((java.lang.String) argOption.valueOf("blah"));

      abstractactor1[2] = spreadsheetsetheadercell7;
