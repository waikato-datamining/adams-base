...
public class SpreadSheetColumnStatisticTest
  ...
  public AbstractActor getActor() {
    ...
    try {
      ...
      adams.data.spreadsheet.statistic.MultiColumnStatistic multicolumnstatistic12 = new adams.data.spreadsheet.statistic.MultiColumnStatistic();
      argOption = (AbstractArgumentOption) multicolumnstatistic12.getOptionManager().findByProperty("statistics");
      adams.data.spreadsheet.statistic.AbstractColumnStatistic[] statistics13 = new adams.data.spreadsheet.statistic.AbstractColumnStatistic[9];
      adams.data.spreadsheet.statistic.Min min14 = new adams.data.spreadsheet.statistic.Min();
      statistics13[0] = min14;
      adams.data.spreadsheet.statistic.Max max15 = new adams.data.spreadsheet.statistic.Max();
      statistics13[1] = max15;
      adams.data.spreadsheet.statistic.Mean mean16 = new adams.data.spreadsheet.statistic.Mean();
      statistics13[2] = mean16;
      adams.data.spreadsheet.statistic.StandardDeviation standarddeviation17 = new adams.data.spreadsheet.statistic.StandardDeviation();
      statistics13[3] = standarddeviation17;
      adams.data.spreadsheet.statistic.Median median18 = new adams.data.spreadsheet.statistic.Median();
      statistics13[4] = median18;
      adams.data.spreadsheet.statistic.IQR iqr19 = new adams.data.spreadsheet.statistic.IQR();
      statistics13[5] = iqr19;
      adams.data.spreadsheet.statistic.Distinct distinct20 = new adams.data.spreadsheet.statistic.Distinct();
      statistics13[6] = distinct20;
      adams.data.spreadsheet.statistic.Unique unique21 = new adams.data.spreadsheet.statistic.Unique();
      statistics13[7] = unique21;
      adams.data.spreadsheet.statistic.Missing missing22 = new adams.data.spreadsheet.statistic.Missing();
