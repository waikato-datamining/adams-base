...
/*
 * SpreadSheetReorderRowsTest.java
...
/**
 * Test for SpreadSheetReorderRows actor.
 *
 * @author fracpete
 * @author adams.core.option.FlowJUnitTestProducer (code generator)
 */
public class SpreadSheetReorderRowsTest
   ...
   */
  public SpreadSheetReorderRowsTest(String name) {
    super(name);
  }
  ...
  public static Test suite() {
    return new TestSuite(SpreadSheetReorderRowsTest.class);
  }
  ...
  public Actor getActor() {
    ...
    try {
      ...
      Actor[] abstractactor1 = new Actor[4];
      ...
      // Flow.SpreadSheetReorderRows
      SpreadSheetReorderRows spreadsheetreordercolumns7 = new SpreadSheetReorderRows();
      argOption = (AbstractArgumentOption) spreadsheetreordercolumns7.getOptionManager().findByProperty("order");
      spreadsheetreordercolumns7.setOrder(new SpreadSheetUnorderedRowRange("last,2,3,10,4,3,last"));
