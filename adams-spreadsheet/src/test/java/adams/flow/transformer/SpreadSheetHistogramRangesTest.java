...
/*
 * SpreadSheetHistogramRangesTest.java
...
/**
 * Test for SpreadSheetHistogramRanges actor.
 *
 * @author fracpete
 * @author adams.core.option.FlowJUnitTestProducer (code generator)
 * @version $Revision$
 */
public class SpreadSheetHistogramRangesTest
   ...
   */
  public SpreadSheetHistogramRangesTest(String name) {
    super(name);
  }
  ...
  public AbstractActor getActor() {
    ...
    try {
      ...
      // Flow.SpreadSheetHistogramRanges
      ...
      argOption = (AbstractArgumentOption) spreadsheethistogramranges.getOptionManager().findByProperty("dataType");
      spreadsheethistogramranges.setDataType((SpreadSheetStatisticDataType) argOption.valueOf("ROW_BY_INDEX"));
      argOption = (AbstractArgumentOption) spreadsheethistogramranges.getOptionManager().findByProperty("locations");
      List<BaseString> locations = new ArrayList<>();
      locations.add((BaseString) argOption.valueOf("1"));
      spreadsheethistogramranges.setLocations(locations.toArray(new BaseString[0]));
      argOption = (AbstractArgumentOption) spreadsheethistogramranges.getOptionManager().findByProperty("numBins");
      spreadsheethistogramranges.setNumBins((Integer) argOption.valueOf("10"));
      actors.add(spreadsheethistogramranges);
