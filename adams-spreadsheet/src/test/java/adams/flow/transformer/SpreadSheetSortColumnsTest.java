...
/*
 * SpreadSheetSortColumnsTest.java
...
/**
 * Test for SpreadSheetSortColumns actor.
 *
 * @author fracpete
 * @author adams.core.option.FlowJUnitTestProducer (code generator)
 * @version $Revision$
 */
public class SpreadSheetSortColumnsTest
   ...
   */
  public SpreadSheetSortColumnsTest(String name) {
    super(name);
  }
  ...
  protected void setUp() throws Exception {
    ...
    m_TestHelper.copyResourceToTmp("unsorted.csv");
  ...
  protected void tearDown() throws Exception {
    m_TestHelper.deleteFileFromTmp("unsorted.csv");
    m_TestHelper.deleteFileFromTmp("dumpfile.csv");
  ...
  public static Test suite() {
    return new TestSuite(SpreadSheetSortColumnsTest.class);
  }
  ...
  public AbstractActor getActor() {
    ...
    try {
      ...
      files.add((PlaceholderFile) argOption.valueOf("${TMP}/unsorted.csv"));
      ...
      // Flow.SpreadSheetSortColumns
      SpreadSheetSortColumns spreadsheetsortcolumns = new SpreadSheetSortColumns();
      argOption = (AbstractArgumentOption) spreadsheetsortcolumns.getOptionManager().findByProperty("columns");
      spreadsheetsortcolumns.setColumns((SpreadSheetColumnRange) argOption.valueOf("2-5"));
      DefaultCompare defaultcompare = new DefaultCompare();
      spreadsheetsortcolumns.setComparator(defaultcompare);

      spreadsheetsortcolumns.setReverse(true);

      actors.add(spreadsheetsortcolumns);
