...
public class NewSpreadSheetTest
   ...
   */
  public NewSpreadSheetTest(String name) {
    super(name);
  }
  ...
  public static Test suite() {
    return new TestSuite(NewSpreadSheetTest.class);
  }
  ...
  public AbstractActor getActor() {
    ...
    try {
      ...
      dumpfile4.setOutputFile((adams.core.io.PlaceholderFile) argOption.valueOf("${TMP}/dumpfile.csv"));

      abstractactor1[1] = dumpfile4;
