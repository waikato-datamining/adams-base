...
public class SpreadSheetProcessor
   ...
   */
  public SpreadSheetProcessor(AbstractApplicationFrame owner) {
    super(owner);
  }
  ...
  public String getIconName() {
    return "spreadsheet_processor.png";
  }
   ...
   */
  public void launch() {
    SpreadSheetProcessorPanel panel = new SpreadSheetProcessorPanel();
