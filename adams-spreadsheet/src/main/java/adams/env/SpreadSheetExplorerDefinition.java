...
/**
 * SpreadSheetExplorerDefinition.java
 * Copyright (C) 2016 University of Waikato, Hamilton, New Zealand
 */
package adams.env;

import adams.gui.visualization.spreadsheet.SpreadSheetExplorer;
 ...
 * @version $Revision$
 */
public class SpreadSheetExplorerDefinition
  ...
  /** the key as constant. */
  public final static String KEY = "spreadsheet explorer";
  ...
  public String getFile() {
    return SpreadSheetExplorer.FILENAME;
  }
  ...
  public void update(AbstractEnvironment env) {
    add(env, Project.NAME + "/gui/visualization/spreadsheet", new String[0]);
  }
}
