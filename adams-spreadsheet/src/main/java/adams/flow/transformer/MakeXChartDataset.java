...
/**
 <!-- globalinfo-start -->
 * Generates a XChart dataset from the incoming spreadsheet.
 * <br><br>
 <!-- globalinfo-end -->
 *
 <!-- flow-summary-start -->
 ...
 */
public class MakeXChartDataset
  ...
  public String globalInfo() {
    return "Generates a XChart dataset from the incoming spreadsheet.";
  }
  ...
  public Class[] generates() {
    return new Class[]{Datasets.class};
  }
