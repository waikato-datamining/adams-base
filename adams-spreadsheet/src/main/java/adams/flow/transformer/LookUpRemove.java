...
public class LookUpRemove
  ...
  public String globalInfo() {
	...
	+ "The string passing through is interpreted as the key to remove.";
  }
  ...
  protected String doExecute() {
	...
	getLogger().warning("Key '" + key + "' not available from lookup table '" + m_StorageName + "', not removed!");
      }
    }
