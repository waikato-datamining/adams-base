...
public class Mean
  ...
  public String globalInfo() {
    return "Determines the mean of the numeric values in the matrix, skips NaN and infinite values.";
  }
  ...
  protected SpreadSheet doGenerate(SpreadSheet sheet) {
    ...
    row.addCell(1).setContent(StatUtils.mean(getNumericValues(sheet).toArray()));
