...
/**
 * SpreadSheetUnescapeColumnName.java
 ...
 * @version $Revision$
 */
public class SpreadSheetUnescapeColumnName
  ...
  public String globalInfo() {
    return "Unescapes a column name (if necessary) that was to be used in a column range expression.";
  }
