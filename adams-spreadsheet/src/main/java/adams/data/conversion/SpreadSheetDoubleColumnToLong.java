...
/**
 <!-- globalinfo-start -->
 * Converts the specified spreadsheet column from double to long.<br/>
 ...
 * @version $Revision$
 */
public class SpreadSheetDoubleColumnToLong
  ...
  protected void convert(Cell cellOld, Cell cellNew) throws Exception {
    cellNew.setContent(cellOld.toDouble().longValue());
  }
}
