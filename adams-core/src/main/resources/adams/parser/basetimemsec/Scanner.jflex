...
// time
[0-9][0-9]:[0-9][0-9]:[0-9][0-9].[0-9][0-9][0-9] { return sf.newSymbol("Date", sym.DATE_ACTUAL, m_Format.parse(yytext())); }
"-INF" { return sf.newSymbol("-INF", sym.DATE_ACTUAL, m_Format.parse(BaseTimeMsec.INF_PAST_DATE)); }
"+INF" { return sf.newSymbol("+INF", sym.DATE_ACTUAL, m_Format.parse(BaseTimeMsec.INF_FUTURE_DATE)); }
"NOW"  { return sf.newSymbol("Now",  sym.DATE_ACTUAL, new Date()); }
"START" { return sf.newSymbol("Start", sym.DATE_START,  m_Format.parse(BaseTimeMsec.INF_PAST_DATE)); }
"END"   { return sf.newSymbol("End",   sym.DATE_END,    m_Format.parse(BaseTimeMsec.INF_FUTURE_DATE)); }
