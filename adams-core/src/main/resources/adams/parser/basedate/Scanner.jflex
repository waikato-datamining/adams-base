...
// date/time
[0-9][0-9][0-9][0-9]-[0-9][0-9]-[0-9][0-9] { return sf.newSymbol("Date", sym.DATE_ACTUAL, getFormat().parse(yytext())); }
"-INF"      { return sf.newSymbol("-INF",  sym.DATE_ACTUAL, getFormat().parse(BaseDate.INF_PAST_DATE)); }
"+INF"      { return sf.newSymbol("+INF",  sym.DATE_ACTUAL, getFormat().parse(BaseDate.INF_FUTURE_DATE)); }
...
"START"     { return sf.newSymbol("Start", sym.DATE_START,  getFormat().parse(BaseDate.INF_PAST_DATE)); }
"END"       { return sf.newSymbol("End",   sym.DATE_END,    getFormat().parse(BaseDate.INF_FUTURE_DATE)); }
