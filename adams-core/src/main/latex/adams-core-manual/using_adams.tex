...
ExecStart=/opt/jdk/bin/java -cp "./lib/*:./lib/linux64/*" adams.flow.FlowRunner -input "./flows/myflow.flow"
...
REM starts myflow
cd C:\\adams
javaw -cp ".\\lib\\*;.\\lib\\windows64\\*" adams.flow.FlowRunner -input ".\\flows\\myflow.flow"
\end{verbatim}}
...
%JCMD% -classpath %CLASSPATH% -Xmx1g adams.flow.FlowRunner headless^
 -input "%BASEDIR%\flows\myflow.flow"^
 -remote-scripting-engine-cmdline^ "adams.scripting.engine.DefaultScriptingEngine -port 12345"^
 -non-interactive true -clean-up true
\end{verbatim}}
