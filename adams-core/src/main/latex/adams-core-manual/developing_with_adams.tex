...
\texttt{.m2}. The full path, on Unix/Linux systems, is as follows:
\begin{verbatim}
  $HOME/.m2
\end{verbatim}
...
{\scriptsize \url{https://adams.cms.waikato.ac.nz/elgg/file/view/226/maven-configuration-file}{}}
...
using the \texttt{0.4.4} release of the template (or \textit{archetype}, to use
