...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Fri Dec 18 09:47:26 NZDT 2015
  */
public class Parser extends java_cup.runtime.lr_parser {
  ...
  public Boolean precedingGenerates(String classname) {
    ...
    return (comp.isCompatible(((OutputProducer) m_Actors[m_Position - 1]).generates(), new Class[]{cls}));
  }
  ...
  public Boolean followingAccepts(String classname) {
    ...
    comp = new Compatibility();
    return (comp.isCompatible(new Class[]{cls}, ((InputConsumer) m_Actors[m_Position + 1]).accepts()));
  }
