...
/*
 * ExternalActorSuggestionDefinition.java
 * Copyright (C) 2018 University of Waikato, Hamilton, New Zealand
 */
package adams.env;

import adams.gui.flow.tree.ExternalActorSuggestion;
 ...
 */
public class ExternalActorSuggestionDefinition
  ...
  /** the key as constant. */
  public final static String KEY = "external actor suggestion";
  ...
  public String getFile() {
    return ExternalActorSuggestion.FILENAME;
  }
