...
/**
 * FlowEditorTreePopupMenuDefinition.java
 ...
 */
public class FlowEditorTreePopupMenuDefinition
  ...
  /** the key as constant. */
  public final static String KEY = "flow editor tree popup menu";
  ...
  public String getFile() {
    return FlowEditorPanel.FILENAME_TREEPOPUPMENU;
  }
  ...
  public void update(AbstractEnvironment env) {
    add(env, Project.NAME + "/gui/flow/tree/menu", new String[0]);
  }
}
