...
/**
 * JenericCmdlineDefinition.java
 * Copyright (C) 2017 University of Waikato, Hamilton, New Zealand
 */
package adams.env;

import adams.core.option.JenericCmdline;
 ...
 * @version $Revision$
 */
public class JenericCmdlineDefinition
  ...
  /** the key as constant. */
  public final static String KEY = "jeneric-cmdline";
  ...
  public String getFile() {
    return JenericCmdline.FILENAME;
  }
