 ...
 */
public class MavenArtifactExclusionParsing {
  ...
  public static String toString(AbstractOption option, Object object) {
    return ((MavenArtifactExclusion) object).stringValue();
  }
  ...
  public static Object valueOf(AbstractOption option, String str) {
    return new MavenArtifactExclusion(str);
  }
}
