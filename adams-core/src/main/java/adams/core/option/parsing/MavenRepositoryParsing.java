 ...
 */
public class MavenRepositoryParsing
  ...
  public static String toString(AbstractOption option, Object object) {
    return ((MavenRepository) object).stringValue();
  }
  ...
  public static Object valueOf(AbstractOption option, String str) {
    return new MavenRepository(Utils.unbackQuoteChars(str));
  }
}
