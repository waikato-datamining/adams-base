 ...
 * @see AdditionalInformationHandler
 */
public class AdditionalInformation
  ...
  public String globalInfo() {
	...
	+ Utils.classToString(AdditionalInformationHandler.class) + " interface.";
  }
  ...
  public boolean handles(Class cls) {
    return ClassLocator.matches(AdditionalInformationHandler.class, cls);
  }
  ...
  public String generate(Object obj, HelpFormat format) {
    ...
    addInfo = ((AdditionalInformationHandler) obj).getAdditionalInformation();
	...
	case HTML:
	  result.append("<h2>Additional information</h2>\n");
	  result.append("<p>" + toHTML(addInfo, true) + "</p>\n");
	  result.append("<br>\n");
	  result.append("\n");
	  break;
