...
public class IntegerOption
   ...
   */
  protected IntegerOption(OptionManager owner, String commandline, String property, Object defValue) {
   ...
   * 				use null to use unbounded
   */
  protected IntegerOption(OptionManager owner, String commandline, String property, Object defValue, Integer lower, Integer upper) {
