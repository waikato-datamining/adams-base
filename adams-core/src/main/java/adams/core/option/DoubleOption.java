...
public class DoubleOption
   ...
   */
  protected DoubleOption(OptionManager owner, String commandline, String property, Object defValue) {
   ...
   * 				use null to use unbounded
   */
  protected DoubleOption(OptionManager owner, String commandline, String property, Object defValue, Double lower, Double upper) {
