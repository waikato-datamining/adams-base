...
public class ByteOption
   ...
   */
  protected ByteOption(OptionManager owner, String commandline, String property, Object defValue) {
   ...
   * 				use null to use unbounded
   */
  protected ByteOption(OptionManager owner, String commandline, String property, Object defValue, Byte lower, Byte upper) {
