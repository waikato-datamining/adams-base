...
public class LongOption
   ...
   */
  protected LongOption(OptionManager owner, String commandline, String property, Object defValue) {
   ...
   * 				use null to use unbounded
   */
  protected LongOption(OptionManager owner, String commandline, String property, Object defValue, Long lower, Long upper) {
