 ...
 */
public class FavoriteActorAfter
  ...
  public String globalInfo() {
    return "Allows the user to select a favorite actor to be inserted after the current location.";
  }
  ...
  protected BaseShortcut getDefaultShortcut() {
    return new BaseShortcut("ctrl alt E");
  }
  ...
  protected String doExecute(StateContainer state) {
    state.tree.getOperations().favoriteActor(state.selPath, TreeOperations.InsertPosition.AFTER, true);
    return null;
  }
}
