...
public class SearchActorAfter
  ...
  public String globalInfo() {
    return "Allows the user to search for an actor to be inserted after the current location.";
  }
  ...
  protected BaseShortcut getDefaultShortcut() {
    return new BaseShortcut("ctrl alt J");
  }
  ...
  protected String doExecute(StateContainer state) {
    state.tree.getOperations().searchActor(state.selPath, TreeOperations.InsertPosition.AFTER, true);
    return null;
  }
}
