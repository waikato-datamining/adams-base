 ...
 * @version $Revision$
 */
public class AddTemplateBeneath
  ...
  public String globalInfo() {
    return "Adds an actor generated from a template beneath the current location.";
  }
  ...
  protected BaseShortcut getDefaultShortcut() {
    return new BaseShortcut("shift F5");
  }
