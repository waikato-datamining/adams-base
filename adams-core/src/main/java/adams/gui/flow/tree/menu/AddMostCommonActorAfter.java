 ...
 * @author fracpete
 */
public class AddMostCommonActorAfter
  ...
  public JMenuItem getMenuItem() {
    ...
    actors    = getMostCommonActors(m_State.selPath, TreeOperations.InsertPosition.AFTER);
    for (i = 0; i < actors.size(); i++) {
      ...
      menuitem.addActionListener((ActionEvent e) -> m_State.tree.getOperations().addActor(
          m_State.selPath, actor, TreeOperations.InsertPosition.AFTER, true, TreeOperations.ActorDialog.GOE_FORCED));
    }
