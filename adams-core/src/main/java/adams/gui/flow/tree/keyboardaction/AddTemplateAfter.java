...
public class AddTemplateAfter
  ...
  public String globalInfo() {
    return "Adds an actor generated from a template after the current location.";
  }
  ...
  protected BaseShortcut getDefaultShortcut() {
    return new BaseShortcut("alt F5");
  }
  ...
  protected String doExecute(StateContainer state) {
    state.tree.getOperations().addActor(state.selPath, m_Template.generate(), TreeOperations.InsertPosition.AFTER, true);
    return null;
  }
}
