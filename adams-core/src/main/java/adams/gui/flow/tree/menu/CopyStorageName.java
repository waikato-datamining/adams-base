...
public class CopyStorageName
  ...
  public JMenu createMenu() {
    ...
    names  = m_State.tree.getOperations().findStorageNames(m_State.selNode.getActor());
  ...
  protected void doUpdate() {
    ...
    if (m_State.isSingleSel) {
      ...
      enabled = !m_State.tree.getOperations().findStorageNames(actor).isEmpty();
    }
