...
/**
 * SelectFileToFileSupplierSuggestion.java
...
/**
 * Suggests FileSupplier as swap partner for SelectFile.
 *
 * @author FracPete (fracpete at waikato dot ac dot nz)
 * @version $Revision$
 */
public class SelectFileToFileSupplierSuggestion
  ...
  public String globalInfo() {
    return "Suggests " + FileSupplier.class + " as swap partner for " + SelectFile.class.getName() + ".";
  }
  ...
  protected List<Actor> doSuggest(Actor current) {
    ...
    if (current instanceof SelectFile)
      result.add(new FileSupplier());
