...
/**
 * SetVariableTransformerToStandaloneSuggestion.java
 ...
 * @version $Revision$
 */
public class SetVariableTransformerToStandaloneSuggestion
  ...
  public String globalInfo() {
    return "Suggests " + adams.flow.standalone.SetVariable.class + " as swap partner for " + adams.flow.transformer.SetVariable.class.getName() + ".";
  }
  ...
  protected List<Actor> doSuggest(Actor current) {
    ...
    if (current instanceof adams.flow.transformer.SetVariable)
      result.add(new adams.flow.standalone.SetVariable());
