 ...
 * @author fracpete
 */
public abstract class AbstractCompareActors
   ...
   */
  protected abstract Actor nodeToActor(Node node);
  ...
  protected void doActionPerformed(ActionEvent e) {
    ...
    for (i = 0; i < 2; i++) {
      ...
      producer.produce(nodeToActor(nodes[i]));
