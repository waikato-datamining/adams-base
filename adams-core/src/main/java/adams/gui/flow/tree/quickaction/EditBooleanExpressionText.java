...
/*
 * EditBooleanExpressionText.java
 ...
 */
public class EditBooleanExpressionText
  ...
  protected String getTitle() {
    return "Edit boolean expression...";
  }
  ...
  protected void doUpdate() {
    ...
    hasMethod = IntrospectionHelper.hasProperty(
      m_State.selNode.getActor().getClass(), EXPRESSION, BooleanExpressionText.class, userMode);
   ...
   */
  protected BooleanExpressionText enterNewExpression(BooleanExpressionText expOld) {
    BooleanExpressionText				result;
    ...
    dialog.setTitle("Enter boolean expression");
    ...
    result = new BooleanExpressionText(panel.getContent());
    return result;
  }
  ...
  protected void doActionPerformed(ActionEvent e) {
    ...
    Actor			actorOld;
    Actor 			actorNew;
    BooleanExpressionText expOld;
    BooleanExpressionText exprNew;
    ...
    expOld = (BooleanExpressionText) PropertyPath.getValue(actorOld, EXPRESSION, errors);
    if (expOld == null)
      expOld = new BooleanExpressionText();
    ...
    if (!updated) {
      GUIHelper.showErrorMessage(parent, "Failed to update boolean expression!");
      return;
    }
    addUndoPoint("Changed boolean expression");
