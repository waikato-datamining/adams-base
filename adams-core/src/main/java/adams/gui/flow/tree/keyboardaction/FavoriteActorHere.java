...
public class FavoriteActorHere
  ...
  public String globalInfo() {
    return "Allows the user to select a favorite actor to be inserted at current location.";
  }
  ...
  protected BaseShortcut getDefaultShortcut() {
    return new BaseShortcut("ctrl E");
  }
  ...
  protected String doExecute(StateContainer state) {
    state.tree.getOperations().favoriteActor(state.selPath, TreeOperations.InsertPosition.HERE, true);
    return null;
  }
}
