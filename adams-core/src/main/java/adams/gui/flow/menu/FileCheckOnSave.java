...
public class FileCheckOnSave
  ...
  protected boolean isInitiallySelected() {
    return FlowEditorPanel.getPropertiesEditor().getBoolean("CheckOnSave", true);
  }
  ...
  protected void doActionPerformed(ActionEvent e) {
    m_State.getCurrentPanel().setCheckOnSave(isSelected());
  }
  ...
  protected void doUpdate() {
    ...
    if (m_State.hasCurrentPanel())
      setSelected(m_State.getCurrentPanel().getCheckOnSave());
  }
}
