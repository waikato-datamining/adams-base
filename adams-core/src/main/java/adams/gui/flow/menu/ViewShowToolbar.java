...
public class ViewShowToolbar
  ...
  public void actionPerformed(ActionEvent e) {
    if (m_State.getToolBarLocation() == ToolBarLocation.HIDDEN)
      ...
      m_State.setToolBarLocation(ToolBarLocation.HIDDEN);
  }
  ...
  protected void doUpdate() {
    setEnabled(true);
    setSelected(m_State.getToolBarLocation() != ToolBarLocation.HIDDEN);
  }
}
