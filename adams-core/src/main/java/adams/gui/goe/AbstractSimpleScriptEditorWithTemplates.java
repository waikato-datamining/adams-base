...
/**
 * AbstractSimpleScriptEditorWithTemplates.java
...
public abstract class AbstractSimpleScriptEditorWithTemplates
  ...
  public final static String FILENAME = "AbstractSimpleScriptEditorTemplates.props";
  ...
  public static synchronized Properties getProperties() {
    if (m_Properties == null)
      m_Properties = Environment.getInstance().read(SimpleScriptEditorTemplatesDefinition.KEY);
