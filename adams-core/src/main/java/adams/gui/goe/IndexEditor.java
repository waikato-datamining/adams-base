...
import adams.core.option.parsing.IndexParsing;
...
public class IndexEditor
  ...
  public String toCustomStringRepresentation(Object obj) {
    return IndexParsing.toString(null, obj);
  }
  ...
  protected JComponent createCustomEditor() {
    ...
    m_ButtonHelp.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent e) {
        HelpFrame.showHelp(getValue().getClass(), getHelpDescription(), false);
      }
    });
  ...
  protected void initForDisplay() {
    ...
    m_TextValue.setToolTipText(createTipText(((Index) getValue()).getExample()));
