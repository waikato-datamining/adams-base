 ...
 * &nbsp;&nbsp;&nbsp;The triangle width in pixels.
 * &nbsp;&nbsp;&nbsp;default: 7
 * &nbsp;&nbsp;&nbsp;minimum: 1
 * </pre>
 * 
 * <pre>-anti-aliasing-enabled &lt;boolean&gt; (property: antiAliasingEnabled)
 * &nbsp;&nbsp;&nbsp;If enabled, uses anti-aliasing for drawing triangles.
 * &nbsp;&nbsp;&nbsp;default: true
 * </pre>
 * 
 <!-- options-end -->
...
public class TrianglePaintlet
  ...
  public String globalInfo() {
    return "Paintlet for simply painting triangles at the specified X-Y position.";
  }
  ...
  public String diameterTipText() {
    return "The triangle width in pixels.";
  }
  ...
  public String antiAliasingEnabledTipText() {
    return "If enabled, uses anti-aliasing for drawing triangles.";
  }
  ...
  protected void doDrawCustomData(Graphics g, PaintMoment moment, XYSequence data, Color color) {
	...
	g.setColor(metaColor.getColor(curr, color));
      ...
      // draw triangle
      x[0] = currX - ((m_Diameter - 1) / 2);
      y[0] = currY + ((m_Diameter - 1) / 2);
      x[1] = x[0] + m_Diameter;
      y[1] = y[0];
      x[2] = currX;
      y[2] = y[0] - m_Diameter;
