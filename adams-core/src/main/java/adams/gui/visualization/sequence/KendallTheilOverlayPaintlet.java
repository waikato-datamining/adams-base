...
/**
 * KendallTheilOverlayPaintlet.java
...
/**
 <!-- globalinfo-start -->
 * Draws a straight line, using slope and intercept determined by Theil-Sen estimator using all the data points in the plot(s).<br>
 * <br>
...
public class KendallTheilOverlayPaintlet
  ...
  public String globalInfo() {
    return
      "Draws a straight line, using slope and intercept determined by Theil-Sen "
	+ "estimator using all the data points in the plot(s).\n\n"
  ...
  public void performPaint(Graphics g, PaintMoment moment) {
    ...
    kt = StatUtils.kendallTheil(x.toArray(), y.toArray());
    ...
    if (m_OutputSlopeIntercept) {
      g.setFont(getFont());
      g.drawString(
	"I: " + Utils.doubleToString(kt[0], 3)
	  + ", S: " + Utils.doubleToString(kt[1], 3),
	m_X - 1,
	m_Y - 1);
    }
