 ...
 * @version $Revision$
 * @see adams.core.management.JDeps
 */
public class JDeps
   ...
   */
  public JDeps(AbstractApplicationFrame owner) {
    super(owner);
  }
  ...
  protected void doLaunch() {
	...
	null, "Enter the options for " + adams.core.management.JDeps.EXECUTABLE + ":",
	adams.core.management.JDeps.getDefaultOptions());
    if (options == null)
      return;

    // run jdeps and display output
    final String fOptions = options;
    SwingWorker worker = new SwingWorker() {
      protected String m_Output = null;
      @Override
      protected Object doInBackground() throws Exception {
	m_Output = adams.core.management.JDeps.execute(fOptions);
	return null;
      }
      @Override
      protected void done() {
	...
	dialog.setTitle(adams.core.management.JDeps.EXECUTABLE);
