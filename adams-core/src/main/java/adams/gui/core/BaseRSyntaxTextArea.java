...
/**
 * A slightly extended version of {@link RSyntaxTextArea}.
 *
 * @author fracpete (fracpete at waikato dot ac dot nz)
 */
public class BaseRSyntaxTextArea 
   ...
   */
  public BaseRSyntaxTextArea(int rows, int columns) {
    super(rows, columns);
    initialize();
  }
   ...
   * @param columns the number of columns >= 0
   */
  public BaseRSyntaxTextArea(String text, int rows, int columns) {
