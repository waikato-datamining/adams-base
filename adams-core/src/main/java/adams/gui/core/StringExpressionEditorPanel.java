...
/**
 * StringExpressionEditorPanel.java
 ...
 * @version $Revision$
 */
public class StringExpressionEditorPanel
  ...
  public final static String FILENAME = "adams/gui/core/StringExpressionEditorPanel.props";
  ...
  public String getAdditionalInformation() {
    return new StringExpression().getGrammar();
  }
  ...
  public StringExpressionText getExpression() {
    return new StringExpressionText(getTextPane().getText());
  }
}
