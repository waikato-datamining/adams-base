...
/**
 <!-- globalinfo-start -->
 * Container for standalone actors.<br>
 ...
 */
public class TimedStandalone
  extends Standalones
  implements TimedActor {

  private static final long serialVersionUID = -8429172353798851452L;
  ...
  public String globalInfo() {
    return
      super.globalInfo() + "\n"
	+ "Times how long the execution of the sub-standalones takes and sends the time "
