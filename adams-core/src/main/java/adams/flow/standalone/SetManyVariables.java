...
/**
 <!-- globalinfo-start -->
 * Sets the values of the variables.<br>
 ...
 * </pre>
 *
 * <pre>-var-pair &lt;adams.core.VariableNameValuePair&gt; [-var-pair ...] (property: variablePairs)
...
public class SetManyVariables
  ...
  public String globalInfo() {
	...
	+ new StringExpression().getGrammar();
  }
  ...
  public void defineOptions() {
    ...
    m_OptionManager.add(
      "var-pair", "variablePairs",
      new VariableNameValuePair[0]);
  ...
  public String variablePairsTipText() {
    return "The name/value pairs of the variables to update.";
  }
  ...
  protected String doExecute() {
	...
	case BOOL_EXPRESSION:
	  try {
	    ...
	    errors.add("Failed to parse boolean expression (" + pair.varValue() + "): " + value, e);
	  }
	  break;
