...
/*
 * CallableDatabaseConnection.java
 ...
 * &nbsp;&nbsp;&nbsp;default: CallableDatabaseConnection
 * </pre>
 *
 ...
 */
public class CallableDatabaseConnection
  extends AbstractCallableDatabaseConnection
   ...
   * Default constructor.
   */
  public CallableDatabaseConnection() {
    super();
  }
   ...
   */
  public CallableDatabaseConnection(CallableActorReference name) {
    this();
   ...
   * @return		the class
   */
  protected Class getRequiredDatabaseConnectionProvider() {
    return DatabaseConnectionProvider.class;
  }
}
