...
/**
 <!-- globalinfo-start -->
 * Evaluates to 'true' if the file change monitor detects a change.<br>
 ...
 * </pre>
 *
 * <pre>-check &lt;adams.core.io.filechanged.FileChangeMonitor&gt; (property: check)
...
public class FileChanged
  ...
  public String checkTipText() {
    return "The file changed monitor to use.";
  }
