...
import adams.flow.transformer.indexedsplitsrunspredictions.NullPredictions;
 ...
 * &nbsp;&nbsp;&nbsp;default: IndexedSplitsRunsPredictions
 * </pre>
 *
 ...
 * </pre>
 *
 * <pre>-generator &lt;adams.flow.transformer.indexedsplitsrunspredictions.IndexedSplitsRunsPredictions&gt; (property: generator)
 * &nbsp;&nbsp;&nbsp;The generator to use for generating predictions for the indexed splits.
 * &nbsp;&nbsp;&nbsp;default: adams.flow.transformer.indexedsplitsrunspredictions.NullPredictions
 * </pre>
 *
 <!-- options-end -->
 *
 ...
 */
public class IndexedSplitsRunsPredictions
  ...
  protected adams.flow.transformer.indexedsplitsrunspredictions.IndexedSplitsRunsPredictions m_Generator;
  ...
  public String globalInfo() {
    return "Uses the specified generator for generating predictions from indexed splits for the incoming data.";
  }
   ...
   */
  public void setGenerator(adams.flow.transformer.indexedsplitsrunspredictions.IndexedSplitsRunsPredictions value) {
    m_Generator = value;
    reset();
  }
   ...
   */
  public adams.flow.transformer.indexedsplitsrunspredictions.IndexedSplitsRunsPredictions getGenerator() {
    return m_Generator;
  }
  ...
  public String generatorTipText() {
    return "The generator to use for generating predictions for the indexed splits.";
  }
  ...
  public Class[] accepts() {
    return new Class[]{m_Generator.accepts()};
  }
  ...
  protected String doExecute() {
	...
	predictions = m_Generator.generate(m_InputToken.getPayload(), runs, errors);
	if (predictions == null) {
	  if (errors.isEmpty())
	  ...
	  m_OutputToken = new Token(predictions);
	}
      }
      catch (Exception e) {
