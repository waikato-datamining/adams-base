...
/**
 <!-- globalinfo-start -->
 * Expands all the variables in the string(s) passing through.A string can consist of arbitrary strings and the following special placeholder for variables:<br>
 * &#64;{...}
 * <br><br>
 <!-- globalinfo-end -->
 *
...
public class ExpandVariables
  ...
  public String globalInfo() {
    return 
	"Expands all the variables in the string(s) passing through."
	+ "A string can consist of arbitrary strings and the following "
	+ "special placeholder for variables:\n"
