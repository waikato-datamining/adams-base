 ...
 * &nbsp;&nbsp;&nbsp;If enabled, the names are output as array instead of one-by-one.
 * &nbsp;&nbsp;&nbsp;default: false
 * </pre>
 *
 <!-- options-end -->
...
public class GetProperties
  ...
  public String outputArrayTipText() {
    return "If enabled, the names are output as array instead of one-by-one.";
  }
  ...
  protected String doExecute() {
    ...
    try {
      ...
      result = handleException("Failed to list properties: " + obj, e);
    }
