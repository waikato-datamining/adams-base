 ...
 * &nbsp;&nbsp;&nbsp;Whether to return the directories as array or one by one.
 * &nbsp;&nbsp;&nbsp;default: false
 * </pre>
 *
 * <pre>-directory &lt;adams.core.io.PlaceholderDirectory&gt; [-directory ...] (property: directories)
 * &nbsp;&nbsp;&nbsp;The dirs to supply.
 * &nbsp;&nbsp;&nbsp;default:
 * </pre>
 *
 ...
 */
public class DirectorySupplier
  ...
  public String getQuickInfo() {
    ...
    result  = QuickInfoHelper.toString(this, "dirs", (m_Directories.length == 1 ? m_Directories[0] : m_Directories.length + " dirs"));
  ...
  public String outputArrayTipText() {
    return "Whether to return the directories as array or one by one.";
  }
  ...
  protected String doExecute() {
	...
	dirStr = FileUtils.useForwardSlashes(dirStr);
      m_Queue.add(dirStr);
    }
