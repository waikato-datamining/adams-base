...
public class CombineStorage
  ...
  public String globalInfo() {
    return 
	"Outputs the expanded string generated from the specified combination "
	+ "expression (variables and storage placeholders). In case of storage "
	+ "placeholders the string representation of the storage item is used.\n"
	+ "The expression string consists of arbitrary strings and the following "
