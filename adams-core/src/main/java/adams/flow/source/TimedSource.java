...
/**
 <!-- globalinfo-start -->
 * Encapsulates a sequence of flow items, with the last one generating the output for this meta-source.<br>
...
public class TimedSource
  ...
  private static final long serialVersionUID = 8375748692520500336L;
  ...
  public String globalInfo() {
    return
      super.globalInfo() + "\n"
	+ "Times how long the sub-source execution takes and sends the time "
