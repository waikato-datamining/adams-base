 ...
 */
public class ListActorReferenceUsage
  extends AbstractListNameUsage<AbstractActorReference> {
  ...
  public String globalInfo() {
    return "Lists all the actors where the specified actor reference name is used.";
  }
  ...
  protected boolean isNameMatch(Object obj) {
    return (obj instanceof AbstractActorReference)
      && ((AbstractActorReference) obj).getValue().equals(m_Name);
  }

  @Override
  protected String getHeader() {
    return "Locations referencing actor '" + m_Name + "':";
  }
}
