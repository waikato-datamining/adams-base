...
/**
 * PropertiesToKeyValuePairs.java
 ...
 */
public class PropertiesToKeyValuePairs
  ...
  public String globalInfo() {
    return "Converts the " + Properties.class.getName() + " into key-value pairs.";
  }
  ...
  protected Object doConvert() throws Exception {
    ...
    while (enm.hasMoreElements()) {
      key = "" + enm.nextElement();
      list.add(new BaseKeyValuePair(key, props.getProperty(key)));
    }
