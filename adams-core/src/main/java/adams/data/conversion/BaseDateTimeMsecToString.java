...
/**
 <!-- globalinfo-start -->
 * Turns a BaseDateTimeMsec format string into a String, evaluted using user-supplied start and end dates (ignored if future INF dates).<br>
 * <br>
 * Example: 2015-12-01 07:13:12.034 +3 MINUTE<br>
 * <br>
 * (&lt;date&gt;|NOW|-INF|+INF|START|END) [expr (MILLISECOND|SECOND|MINUTE|HOUR|DAY|WEEK|MONTH|YEAR)]*<br>
 * <br>
 * expr ::=   ( expr )<br>
 *          | - expr<br>
 *          | + expr<br>
 ...
 * </pre>
 * 
 * <pre>-start &lt;adams.core.base.BaseDateTimeMsec&gt; (property: start)
 * &nbsp;&nbsp;&nbsp;The start date to use in the evaluation.
 * &nbsp;&nbsp;&nbsp;default: -INF
 * </pre>
 * 
 * <pre>-end &lt;adams.core.base.BaseDateTimeMsec&gt; (property: end)
...
public class BaseDateTimeMsecToString
  ...
  public String globalInfo() {
    return
        "Turns a BaseDateTimeMsec format string into a String, evaluted using "
  ...
  public String getGrammar() {
    return new BaseDateTimeMsec().getGrammar();
  }
  ...
  protected Object doConvert() throws Exception {
    ...
    result = new BaseDateTimeMsec((String) m_Input);
