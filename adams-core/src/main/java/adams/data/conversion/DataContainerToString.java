...
import adams.data.io.output.StreamableTextBasedDataContainerWriter;
 ...
 * </pre>
 *
 * <pre>-writer &lt;adams.data.io.output.StreamableTextBasedDataContainerWriter&gt; (property: writer)
 * &nbsp;&nbsp;&nbsp;The writer to use for turning the data container into a byte array.
 * &nbsp;&nbsp;&nbsp;default: adams.data.conversion.DataContainerToString$DummyWriter
 * </pre>
 *
 <!-- options-end -->
 *
 ...
 */
public class DataContainerToString
  ...
  public static class DummyWriter
    ...
    implements StreamableTextBasedDataContainerWriter<DummyContainer> {
  ...
  protected StreamableTextBasedDataContainerWriter m_Writer;
   ...
   */
  public void setWriter(StreamableTextBasedDataContainerWriter value) {
    m_Writer = value;
    reset();
  }
   ...
   * @return 		the writer
   */
  public StreamableTextBasedDataContainerWriter getWriter() {
    return m_Writer;
  }
  ...
  protected Object doConvert() throws Exception {
    StreamableTextBasedDataContainerWriter	writer;
