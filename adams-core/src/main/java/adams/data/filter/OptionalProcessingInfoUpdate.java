...
/*
 * OptionalProcessingInfoUpdate.java
...
/**
 * Interface for classes that can suppress the update of the processing information.
 *
 * @author fracpete (fracpete at waikato dot ac dot nz)
 * @see NotesHandler
 */
public interface OptionalProcessingInfoUpdate {
