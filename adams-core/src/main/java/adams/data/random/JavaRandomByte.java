 ...
 */
public class JavaRandomByte
  extends AbstractSeededRandomNumberGenerator<Byte> {
  ...
  public String globalInfo() {
    return "Random generator that generates random bytes using Java's java.util.Random class.";
  }
