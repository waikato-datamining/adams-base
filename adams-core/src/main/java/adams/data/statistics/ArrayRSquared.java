...
/**
 <!-- globalinfo-start -->
 * Calculates the R^2 between the first array and the remaining arrays. The arrays must be numeric, of course.
 * <br><br>
 <!-- globalinfo-end -->
 *
 <!-- options-start -->
 ...
 */
public class ArrayRSquared<T extends Number>
  ...
  public String globalInfo() {
    return
        "Calculates the R^2 between the first array and "
  ...
  protected StatisticContainer doCalculate() {
    ...
    for (i = 1; i < size(); i++) {
      result.setHeader(i - 1, "R^2 1-" + (i+1));
      result.setCell(0, i - 1, StatUtils.rSquared(get(0), get(i)));
    }
