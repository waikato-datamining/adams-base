...
public class OpenFileTest
  ...
  protected void setUp() throws Exception {
    ...
    m_TestHelper.copyResourceToTmp("adams_logo.png", "openfile.png");
  }
  ...
  protected void tearDown() throws Exception {
    // delete is too fast, happens before native application starts up
    //m_TestHelper.deleteFileFromTmp("openfile.png");
  ...
  public static Test suite() {
    return new TestSuite(OpenFileTest.class);
  }
  ...
  public AbstractActor getActor() {
    ...
    try {
      ...
      files3[0] = (adams.core.io.PlaceholderFile) argOption.valueOf("${TMP}/openfile.png");
      filesupplier2.setFiles(files3);
      actors1[0] = filesupplier2;

      // Flow.OpenFile
      adams.flow.sink.OpenFile openfile4 = new adams.flow.sink.OpenFile();
      actors1[1] = openfile4;
