...
import adams.flow.sink.sendnotification.Console;
...
/**
 * Test for SendNotification actor.
 *
 * @author fracpete
...
public class SendNotificationTest
   ...
   */
  public SendNotificationTest(String name) {
    super(name);
  }
  ...
  public static Test suite() {
    return new TestSuite(SendNotificationTest.class);
  }
  ...
  public AbstractActor getActor() {
    ...
    try {
      ...
      strings.add((BaseString) argOption.valueOf("yo!"));
      ...
      sendnotification.setNotification(console);

      actors.add(sendnotification);
