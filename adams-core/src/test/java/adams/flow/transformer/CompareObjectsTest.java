...
public class CompareObjectsTest
  ...
  public static Test suite() {
    return new TestSuite(CompareObjectsTest.class);
  }
  ...
  public Actor getActor() {
    ...
    try {
      ...
      strings.add((BaseString) argOption.valueOf("abc"));
      strings.add((BaseString) argOption.valueOf("abd"));
      strings.add((BaseString) argOption.valueOf("def"));
      strings.add((BaseString) argOption.valueOf("def"));
      ...
      sequencetoarray.setArrayLength((Integer) argOption.valueOf("2"));
      actors.add(sequencetoarray);

      // Flow.CompareObjects
      CompareObjects compareobjects = new CompareObjects();
      JavaComparable javacomparable = new JavaComparable();
      compareobjects.setCompare(javacomparable);

      actors.add(compareobjects);
