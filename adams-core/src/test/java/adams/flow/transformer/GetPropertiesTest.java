...
import adams.flow.source.NewReport;
...
public class GetPropertiesTest
   ...
   */
  public GetPropertiesTest(String name) {
    super(name);
  }
  ...
  public static Test suite() {
    return new TestSuite(GetPropertiesTest.class);
  }
  ...
  public AbstractActor getActor() {
    ...
    try {
      ...
      actors.add(newreport);

      // Flow.GetProperties
      GetProperties getproperties = new GetProperties();
      getproperties.setOutputArray(true);

      actors.add(getproperties);
