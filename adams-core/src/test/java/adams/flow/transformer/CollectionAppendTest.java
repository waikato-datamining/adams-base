...
/**
 * Test for CollectionAppend actor.
 *
 * @author fracpete
 * @author adams.core.option.FlowJUnitTestProducer (code generator)
 */
public class CollectionAppendTest
   ...
   */
  public CollectionAppendTest(String name) {
    super(name);
  }
  ...
  public static Test suite() {
    return new TestSuite(CollectionAppendTest.class);
  }
