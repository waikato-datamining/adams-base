...
import adams.flow.sink.RemoteCommandWriter;
...
/**
 * Test for RemoteCommandReader actor.
 *
 * @author fracpete
 * @author adams.core.option.FlowJUnitTestProducer (code generator)
 * @version $Revision$
 */
public class RemoteCommandReaderTest
   ...
   */
  public RemoteCommandReaderTest(String name) {
    super(name);
  }
  ...
  public static Test suite() {
    return new TestSuite(RemoteCommandReaderTest.class);
  }
  ...
  public AbstractActor getActor() {
    ...
    try {
      ...
      files.add((PlaceholderFile) argOption.valueOf("${TMP}/example.rc"));
