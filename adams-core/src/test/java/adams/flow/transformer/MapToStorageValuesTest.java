...
/**
 * Test for MapToStorageValues actor.
 *
 * @author fracpete
 */
public class MapToStorageValuesTest
   ...
   */
  public MapToStorageValuesTest(String name) {
    super(name);
  }
  ...
  public static Test suite() {
    return new TestSuite(MapToStorageValuesTest.class);
  }
  ...
  public AbstractActor getActor() {
    ...
    try {
      ...
      // Flow.MapToStorageValues
      MapToStorageValues maptostorage = new MapToStorageValues();
      argOption = (AbstractArgumentOption) maptostorage.getOptionManager().findByProperty("regExp");
      maptostorage.setRegExp((BaseRegExp) argOption.valueOf("t.*"));
      argOption = (AbstractArgumentOption) maptostorage.getOptionManager().findByProperty("storageNamePrefix");
      maptostorage.setStorageNamePrefix((String) argOption.valueOf("blah_"));
      actors.add(maptostorage);
      ...
      DumpStorage dumpvariables = new DumpStorage();
