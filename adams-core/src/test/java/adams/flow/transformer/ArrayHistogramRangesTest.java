...
/**
 * Test for ArrayHistogramRanges actor.
 *
 * @author fracpete
 * @author adams.core.option.FlowJUnitTestProducer (code generator)
 * @version $Revision$
 */
public class ArrayHistogramRangesTest
   ...
   */
  public ArrayHistogramRangesTest(String name) {
    super(name);
  }
  ...
  public static Test suite() {
    return new TestSuite(ArrayHistogramRangesTest.class);
  }
  ...
  public AbstractActor getActor() {
    ...
    try {
      ...
      // Flow.ArrayHistogramRanges
      ArrayHistogramRanges arrayhistogramranges = new ArrayHistogramRanges();
      arrayhistogramranges.setOutputArray(true);

      argOption = (AbstractArgumentOption) arrayhistogramranges.getOptionManager().findByProperty("numBins");
      arrayhistogramranges.setNumBins((Integer) argOption.valueOf("20"));
      actors.add(arrayhistogramranges);
