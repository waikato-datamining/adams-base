...
public class TextRendererTest
  ...
  public AbstractActor getActor() {
    ...
    try {
      ...
      strings.add((BaseString) argOption.valueOf("few"));
      strings.add((BaseString) argOption.valueOf("strings"));
      strings.add((BaseString) argOption.valueOf("to"));
      strings.add((BaseString) argOption.valueOf("insert"));
