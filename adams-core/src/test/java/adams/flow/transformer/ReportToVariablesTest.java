...
/**
 * Test for ReportToVariables actor.
 *
 * @author fracpete
 * @author adams.core.option.FlowJUnitTestProducer (code generator)
 * @version $Revision$
 */
public class ReportToVariablesTest
   ...
   */
  public ReportToVariablesTest(String name) {
    super(name);
  }
  ...
  public static Test suite() {
    return new TestSuite(ReportToVariablesTest.class);
  }
  ...
  public Actor getActor() {
    ...
    try {
      ...
      // Flow.ReportToVariables
      ReportToVariables reporttovariables = new ReportToVariables();
      argOption = (AbstractArgumentOption) reporttovariables.getOptionManager().findByProperty("prefix");
      reporttovariables.setPrefix((String) argOption.valueOf("blah."));
      actors.add(reporttovariables);
      ...
      dumpvariables.setRegExp((BaseRegExp) argOption.valueOf("blah.*"));
      actors3.add(dumpvariables);
