...
/**
 * Test for CombineCollections actor.
 *
 * @author fracpete
 * @author adams.core.option.FlowJUnitTestProducer (code generator)
 */
public class CombineCollectionsTest
   ...
   */
  public CombineCollectionsTest(String name) {
    super(name);
  }
  ...
  public static Test suite() {
    return new TestSuite(CombineCollectionsTest.class);
  }
  ...
  public AbstractActor getActor() {
    ...
    try {
      ...
      // Flow.combine.CombineCollections
      CombineCollections combinecollections = new CombineCollections();
      argOption = (AbstractArgumentOption) combinecollections.getOptionManager().findByProperty("storageNames");
      ...
      combinecollections.setStorageNames(storagenames.toArray(new StorageName[0]));
      actors4.add(combinecollections);

      // Flow.combine.CollectionToArray
