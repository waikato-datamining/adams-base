...
/**
 * Test for NewRemoteCommand actor.
 *
 * @author fracpete
 * @author adams.core.option.FlowJUnitTestProducer (code generator)
 * @version $Revision$
 */
public class NewRemoteCommandTest
   ...
   */
  public NewRemoteCommandTest(String name) {
    super(name);
  }
  ...
  public static Test suite() {
    return new TestSuite(NewRemoteCommandTest.class);
  }
