...
public class DumpStorageTest
   ...
   */
  public DumpStorageTest(String name) {
    super(name);
  }
  ...
  public static Test suite() {
    return new TestSuite(DumpStorageTest.class);
  }
  ...
  public AbstractActor getActor() {
    ...
    try {
      ...
      adams.flow.transformer.SetStorageValue setstoragevalue3 = new adams.flow.transformer.SetStorageValue();
      argOption = (AbstractArgumentOption) setstoragevalue3.getOptionManager().findByProperty("storageName");
      setstoragevalue3.setStorageName((adams.flow.control.StorageName) argOption.valueOf("val"));
      actors1[1] = setstoragevalue3;
      ...
      // Flow.Trigger-1.DumpStorage
      adams.flow.source.DumpStorage dumpstorage8 = new adams.flow.source.DumpStorage();
      argOption = (AbstractArgumentOption) dumpstorage8.getOptionManager().findByProperty("regExp");
      dumpstorage8.setRegExp((adams.core.base.BaseRegExp) argOption.valueOf("v.*"));
      actors7[0] = dumpstorage8;
