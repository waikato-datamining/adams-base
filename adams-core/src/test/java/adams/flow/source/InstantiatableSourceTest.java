...
/**
 * Tests the InstantiatableSource actor. The external flow uses an
 * InstantiatableSource actor.
 *
 * @author  fracpete (fracpete at waikato dot ac dot nz)
 * @version $Revision$
 */
public class InstantiatableSourceTest
   ...
   */
  public InstantiatableSourceTest(String name) {
    super(name);
  }
  ...
  public static Test suite() {
    return new TestSuite(InstantiatableSourceTest.class);
  }
