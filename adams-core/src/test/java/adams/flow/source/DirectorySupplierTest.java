...
/**
 * Tests the DirectorySupplier actor.
 *
 * @author  fracpete (fracpete at waikato dot ac dot nz)
 */
public class DirectorySupplierTest
   ...
   */
  public DirectorySupplierTest(String name) {
    super(name);
  }
  ...
  public static Test suite() {
    return new TestSuite(DirectorySupplierTest.class);
  }
