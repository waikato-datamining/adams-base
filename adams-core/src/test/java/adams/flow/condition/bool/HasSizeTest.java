...
/**
 * Tests the 'HasSize' boolean condition.
 * 
...
public class HasSizeTest
   ...
   */
  public HasSizeTest(String name) {
    super(name);
  }
  ...
  protected AbstractBooleanCondition[] getRegressionSetups() {
    ...
    result    = new HasSize[3];
    result[0] = new HasSize();
    result[1] = new HasSize();
    result[1].setMinSize(0);
    result[2] = new HasSize();
    result[2].setMinSize(5);
  ...
  public static Test suite() {
    return new TestSuite(HasSizeTest.class);
  }
