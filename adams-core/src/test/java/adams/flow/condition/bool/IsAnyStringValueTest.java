...
/**
 * Tests the 'IsAnyStringValue' boolean condition.
 * 
 * @author  fracpete (fracpete at waikato dot ac dot nz)
 */
public class IsAnyStringValueTest
   ...
   */
  public IsAnyStringValueTest(String name) {
    super(name);
  }
  ...
  protected AbstractBooleanCondition[] getRegressionSetups() {
    return new IsAnyStringValue[]{
	new IsAnyStringValue(),
	new IsAnyStringValue(new String[]{"blah"}),
	new IsAnyStringValue(new String[]{"blah", "Blah"}),
	new IsAnyStringValue(new String[]{"blah"}),
	new IsAnyStringValue(new String[]{"blah"}),
    };
  }
  ...
  public static Test suite() {
    return new TestSuite(IsAnyStringValueTest.class);
  }
