...
/**
 * Tests the 'HasElements' boolean condition.
 * 
...
public class HasElementsTest
   ...
   */
  public HasElementsTest(String name) {
    super(name);
  }
  ...
  protected AbstractBooleanCondition[] getRegressionSetups() {
    ...
    result    = new HasElements[3];
    result[0] = new HasElements();
    result[1] = new HasElements();
    result[1].setMinElements(0);
    result[2] = new HasElements();
    result[2].setMinElements(5);
  ...
  public static Test suite() {
    return new TestSuite(HasElementsTest.class);
  }
