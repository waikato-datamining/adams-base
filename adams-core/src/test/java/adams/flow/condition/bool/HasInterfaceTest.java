...
/**
 * Tests the 'HasInterface' boolean condition.
 * 
...
public class HasInterfaceTest
   ...
   */
  public HasInterfaceTest(String name) {
    super(name);
  }
  ...
  protected AbstractBooleanCondition[] getRegressionSetups() {
    ...
    result    = new HasInterface[3];
    result[0] = new HasInterface();
    result[1] = new HasInterface();
    result[1].setInterface(Actor.class.getName());
    result[2] = new HasInterface();
    result[2].setInterface(ControlActor.class.getName());
  ...
  public static Test suite() {
    return new TestSuite(HasInterfaceTest.class);
  }
