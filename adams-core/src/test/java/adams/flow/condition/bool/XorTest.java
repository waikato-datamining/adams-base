...
/**
 * Tests the 'Xor' boolean condition.
 *
...
public class XorTest
  ...
  protected AbstractBooleanCondition[] getRegressionSetups() {
    ...
    result    = new Xor[4];
    result[0] = new Xor(new True(),  new True());
    result[1] = new Xor(new True(),  new False());
    result[2] = new Xor(new False(), new True());
    result[3] = new Xor(new False(), new False());
  ...
  public static Test suite() {
    return new TestSuite(XorTest.class);
  }
