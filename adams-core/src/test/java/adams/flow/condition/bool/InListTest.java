...
/**
 * Tests the 'InList' boolean condition.
 * 
...
public class InListTest
  ...
  protected AbstractBooleanCondition[] getRegressionSetups() {
    ...
    result[0] = new InList();
    result[1] = new InList();
    result[1].setItems(new BaseString[]{
      new BaseString("BLAH"),
    });
    result[2] = new InList();
    result[2].setItems(new BaseString[]{
      new BaseString("something"),
      new BaseString("blah"),
      new BaseString("BLAH"),
    });
  ...
  public static Test suite() {
    return new TestSuite(InListTest.class);
  }
