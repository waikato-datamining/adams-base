...
/**
 * Tests the 'DirectoryExists' boolean condition.
 * 
...
public class DirectoryExistsTest
   ...
   */
  public DirectoryExistsTest(String name) {
    super(name);
  }
  ...
  protected AbstractBooleanCondition[] getRegressionSetups() {
    ...
    result    = new DirectoryExists[2];
    result[0] = new DirectoryExists();
    result[1] = new DirectoryExists();
  ...
  public static Test suite() {
    return new TestSuite(DirectoryExistsTest.class);
  }
