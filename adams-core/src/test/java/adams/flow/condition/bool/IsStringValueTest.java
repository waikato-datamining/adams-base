...
/**
 * Tests the 'IsStringValue' boolean condition.
 * 
 * @author  fracpete (fracpete at waikato dot ac dot nz)
 */
public class IsStringValueTest
   ...
   */
  public IsStringValueTest(String name) {
    super(name);
  }
  ...
  protected AbstractBooleanCondition[] getRegressionSetups() {
    return new IsStringValue[]{
	new IsStringValue(),
	new IsStringValue("blah"),
	new IsStringValue("blah"),
	new IsStringValue("blah"),
	new IsStringValue("blah"),
    };
  ...
  public static Test suite() {
    return new TestSuite(IsStringValueTest.class);
  }
