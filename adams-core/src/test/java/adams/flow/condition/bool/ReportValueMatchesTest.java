...
/**
 * Tests the 'ReportValueMatches' boolean condition.
 *
 * @author  fracpete (fracpete at waikato dot ac dot nz)
 */
public class ReportValueMatchesTest
   ...
   */
  public ReportValueMatchesTest(String name) {
    super(name);
  }
  ...
  protected Object[] getRegressionInputs() {
    ...
    result[2] = result[0].getClone();
    result[3] = result[0].getClone();
  ...
  protected AbstractBooleanCondition[] getRegressionSetups() {
    ReportValueMatches[]	result;

    result    = new ReportValueMatches[4];
    result[0] = new ReportValueMatches();
    result[1] = new ReportValueMatches(new Field("key1", DataType.STRING), "string");
    result[2] = new ReportValueMatches(new Field("key2", DataType.BOOLEAN), "true");
    result[3] = new ReportValueMatches(new Field("key4", DataType.NUMERIC), "0.3");
  ...
  public static Test suite() {
    return new TestSuite(ReportValueMatchesTest.class);
  }
