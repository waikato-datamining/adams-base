...
/**
 * Tests the 'DirectoriesMatch' boolean condition.
 * <p/>
 * NB: Dummy test.
 * 
 ...
 * @version $Revision$
 */
public class DirectoriesMatchTest
   ...
   */
  public DirectoriesMatchTest(String name) {
    super(name);
  }
  ...
  protected AbstractBooleanCondition[] getRegressionSetups() {
    return new AbstractBooleanCondition[]{
    };
  }
  ...
  public static Test suite() {
    return new TestSuite(DirectoriesMatchTest.class);
  }
