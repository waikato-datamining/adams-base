...
/**
 * Test class for the CountValues feature converter. Run from the command line with: <br><br>
 * java adams.data.featureconverter.CountValuesTest
 * 
...
public class CountValuesTest
  ...
  protected HeaderDefinition[] getRegressionHeaderDefinitions() {
    ...
    result[0].add("number1", DataType.NUMERIC);
    result[0].add("number2", DataType.NUMERIC);
    result[0].add("number3", DataType.NUMERIC);
  ...
  protected AbstractFeatureConverter[] getRegressionSetups() {
    ...
    result    = new CountValues[1];
    result[0] = new CountValues();
    result[0].setMinimum(2.0);
    result[0].setMaximumIncluded(false);
