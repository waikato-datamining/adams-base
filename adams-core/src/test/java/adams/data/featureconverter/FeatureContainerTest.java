...
/**
 * Test class for the FeatureContainer feature converter. Run from the command line with: <br><br>
 * java adams.data.featureconverter.FeatureContainerTest
 * 
...
public class FeatureContainerTest
   ...
   */
  public FeatureContainerTest(String name) {
    super(name);
  }
  ...
  public static Test suite() {
    return new TestSuite(FeatureContainerTest.class);
  }
