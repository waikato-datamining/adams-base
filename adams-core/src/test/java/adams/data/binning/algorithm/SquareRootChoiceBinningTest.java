...
/*
 * SquareRootChoiceBinningTest.java
...
/**
 * Tests SquareRootChoiceBinning.
 *
 * @author FracPete (fracpete at waikato dot ac dot nz)
 */
public class SquareRootChoiceBinningTest
   ...
   */
  public SquareRootChoiceBinningTest(String name) {
    super(name);
  }
  ...
  public static Test suite() {
    return new TestSuite(SquareRootChoiceBinningTest.class);
  }
