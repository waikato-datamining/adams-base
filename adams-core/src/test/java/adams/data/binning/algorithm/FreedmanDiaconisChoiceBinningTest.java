...
/*
 * FreedmanDiaconisChoiceBinningTest.java
...
/**
 * Tests FreedmanDiaconisChoiceBinning.
 *
 * @author FracPete (fracpete at waikato dot ac dot nz)
 */
public class FreedmanDiaconisChoiceBinningTest
   ...
   */
  public FreedmanDiaconisChoiceBinningTest(String name) {
    super(name);
  }
  ...
  public static Test suite() {
    return new TestSuite(FreedmanDiaconisChoiceBinningTest.class);
  }
