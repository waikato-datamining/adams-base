...
/**
 * Tests DensityBinning.
 *
 * @author FracPete (fracpete at waikato dot ac dot nz)
 */
public class DensityBinningTest
   ...
   */
  public DensityBinningTest(String name) {
    super(name);
  }
  ...
  public static Test suite() {
    return new TestSuite(DensityBinningTest.class);
  }
