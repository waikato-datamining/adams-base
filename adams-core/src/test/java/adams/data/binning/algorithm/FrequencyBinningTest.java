...
/**
 * Tests FrequencyBinning.
 *
 * @author FracPete (fracpete at waikato dot ac dot nz)
 */
public class FrequencyBinningTest
   ...
   */
  public FrequencyBinningTest(String name) {
    super(name);
  }
  ...
  public static Test suite() {
    return new TestSuite(FrequencyBinningTest.class);
  }
