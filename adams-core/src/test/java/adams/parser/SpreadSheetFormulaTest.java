...
/**
 * Tests the adams.parser.SpreadSheetFormula class. Run from commandline with: <br><br>
...
public class SpreadSheetFormulaTest
  ...
  protected String[][] getRegressionExpressions() {
    return new String[][]{
	{
	  ...
	  "contains(\"998877665544\"; \"76\")",		// 87
	  "contains(\"998877665544\"; \"767\")",		// 88
	  "startswith(\"998877665544\"; \"99\")",		// 89
	  "startswith(\"998877665544\"; \"98\")",		// 90
	  "endswith(\"998877665544\"; \"44\")",		// 91
	  "endswith(\"998877665544\"; \"43\")",		// 92
	}
    };
  }
