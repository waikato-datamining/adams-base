...
public class JythonTest
  ...
  protected void setUp() throws Exception {
    ...
    m_TestHelper.copyResourceToTmp("SimpleTransformer.py");
  ...
  protected void tearDown() throws Exception {
    m_TestHelper.deleteFileFromTmp("SimpleTransformer.py");
    m_TestHelper.deleteFileFromTmp("dumpfile.txt");
  ...
  public Actor getActor() {
    ...
    gr.setScriptFile(new TmpFile("SimpleTransformer.py"));
    ...
    Flow flow = new Flow();
    flow.setActors(new Actor[]{sc, con, gr, df});
