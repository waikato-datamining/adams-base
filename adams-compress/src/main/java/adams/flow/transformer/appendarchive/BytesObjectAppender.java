...
/**
 * Adds byte arrays to the archive.
 *
 * @author fracpete (fracpete at waikato dot ac dot nz)
 */
public class BytesObjectAppender
  ...
  public String globalInfo() {
    return "Adds byte arrays to the archive.";
  }
  ...
  public String process(ArchiveManager manager, Object obj, String name) {
    return manager.add((byte[]) obj, name);
  }
}
