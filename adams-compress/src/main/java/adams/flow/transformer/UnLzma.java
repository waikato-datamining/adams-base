...
/**
 <!-- globalinfo-start -->
 * Decompresses an archive that was compressed with LZMA (7zip). It is assumed, that the file ends with .7z. If that is not the case, an alternative filename has to be provided.<br>
...
public class UnLzma
  ...
  public String globalInfo() {
    return
        "Decompresses an archive that was compressed with LZMA (7zip). It is assumed, "
      + "that the file ends with " + LzmaUtils.EXTENSION + ". If that is not the "
  ...
  public String useAlternativeOutputDirTipText() {
    return
      ...
      + "location as the archive with the " + LzmaUtils.EXTENSION + " extension; "
  ...
  public String alternativeFilenameTipText() {
    return
      ...
      + "file with the " + LzmaUtils.EXTENSION + " extension removed.";
  }
  ...
  protected String decompress(File inFile, File outFile) {
    return LzmaUtils.decompress(inFile, m_BufferSize, outFile);
  }
  ...
  protected String decompress(byte[] inBytes, TByteList outBytes) {
    ...
    decompressed = LzmaUtils.decompress(inBytes, m_BufferSize, errors);
