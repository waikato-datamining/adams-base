...
/**
 <!-- globalinfo-start -->
 * Decompresses an archive that was compressed with Zstd. It is assumed, that the file ends with .7z. If that is not the case, an alternative filename has to be provided.<br>
...
public class UnZstd
  ...
  public String globalInfo() {
    return
        "Decompresses an archive that was compressed with Zstd. It is assumed, "
      + "that the file ends with " + ZstdUtils.EXTENSION + ". If that is not the "
  ...
  public String useAlternativeOutputDirTipText() {
    return
      ...
      + "location as the archive with the " + ZstdUtils.EXTENSION + " extension; "
  ...
  public String alternativeFilenameTipText() {
    return
      ...
      + "file with the " + ZstdUtils.EXTENSION + " extension removed.";
  }
  ...
  protected String decompress(File inFile, File outFile) {
    return ZstdUtils.decompress(inFile, m_BufferSize, outFile);
  }
  ...
  protected String decompress(byte[] inBytes, TByteList outBytes) {
    ...
    decompressed = ZstdUtils.decompress(inBytes, m_BufferSize, errors);
