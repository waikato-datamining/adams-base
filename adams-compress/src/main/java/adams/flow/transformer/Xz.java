 ...
 * &nbsp;&nbsp;&nbsp;The XZ (7zip) file to create; if pointing to a directory, then the output 
...
public class Xz
  ...
  public String globalInfo() {
    return
        "Creates a XZ archive from a single file. Outputs the filename "
      + "of the XZ file generated. Optionally, the original input file can "
      + "be deleted.";
  }
  ...
  public String outputTipText() {
    return
        "The XZ file to create; if pointing to a directory, then the output "
      + "filename is based on the file that is being compressed and the '" + XzUtils.EXTENSION + "' "
      + "extension added.";
  }
