...
/**
 * Tests the UnXz actor.
 *
 * @author  fracpete (fracpete at waikato dot ac dot nz)
 */
public class UnXzTest
  ...
  protected void setUp() throws Exception {
    ...
    m_TestHelper.deleteFileFromTmp("external_standalone.flow.xz");
  ...
  public Actor getActor() {
    ...
    UnXz decomp = new UnXz();
    decomp.setAlternativeFilename("external_standalone2.flow");
    ...
    Flow flow = new Flow();
    flow.setActors(new Actor[]{sc, comp, decomp, tfr, a2s, df});
  ...
  public static Test suite() {
    return new TestSuite(UnXzTest.class);
  }
