...
/*
 * ExcelStreamingSpreadSheetWriterTest.java
...
/**
 * Tests the adams.data.io.output.ExcelStreamingSpreadSheetWriter class. Run from commandline with: <br><br>
 * java adams.data.io.output.ExcelStreamingSpreadSheetWriter
 *
 * @author  fracpete (fracpete at waikato dot ac dot nz)
 * @version $Revision$
 */
public class ExcelStreamingSpreadSheetWriterTest
   ...
   */
  public ExcelStreamingSpreadSheetWriterTest(String name) {
    super(name);
  }
  ...
  protected SpreadSheetWriter[] getSetups() {
	...
	// TODO
	//new ExcelStreamingSpreadSheetWriter(),
	//new ExcelStreamingSpreadSheetWriter()
    };
  }
