 ...
 * @version $Revision: 74 $
 */
public class Dilate4
  extends AbstractBoofCVTransformer {

  /** for serialization. */
  private static final long serialVersionUID = 3446616869164151955L;
  ...
  public String globalInfo() {
    return "Applies the BoofCV dilate4 algorithm to a binary image.";
  }
  ...
  protected BoofCVImageContainer[] doTransform(BoofCVImageContainer img) {
    ...
    filtered  = BinaryImageOps.dilate4(input, m_NumTimes, null);
