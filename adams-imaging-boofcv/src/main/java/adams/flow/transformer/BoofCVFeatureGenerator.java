 ...
 * </pre>
 * 
 * <pre>-algorithm &lt;AbstractBoofCVFeatureGenerator&gt; (property: algorithm)
...
public class BoofCVFeatureGenerator
  ...
  implements FeatureGenerator<AbstractBoofCVFeatureGenerator> {
   ...
   */
  public void setAlgorithm(AbstractBoofCVFeatureGenerator value) {
    m_Algorithm = value;
    reset();
  }
   ...
   */
  public AbstractBoofCVFeatureGenerator getAlgorithm() {
    return m_Algorithm;
  }
