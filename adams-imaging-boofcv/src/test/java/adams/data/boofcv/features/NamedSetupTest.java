...
/**
 * Test class for the NamedSetup features. Run from the command line with: <br><br>
 * java adams.data.boofcv.features.NamedSetupTest
 *
...
public class NamedSetupTest
  ...
  protected AbstractBoofCVFeatureGenerator[] getRegressionSetups() {
    ...
    result[0].setSetup(new adams.core.NamedSetup("boofcv_features_pixels"));
