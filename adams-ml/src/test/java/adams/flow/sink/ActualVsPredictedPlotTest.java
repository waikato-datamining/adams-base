...
/*
 * ActualVsPredictedPlotTest.java
...
/**
 * Test for ActualVsPredictedPlot actor.
 *
 * @author fracpete
 * @author adams.core.option.FlowJUnitTestProducer (code generator)
 * @version $Revision$
 */
public class ActualVsPredictedPlotTest
   ...
   */
  public ActualVsPredictedPlotTest(String name) {
    super(name);
  }
  ...
  public static Test suite() {
    return new TestSuite(ActualVsPredictedPlotTest.class);
  }
