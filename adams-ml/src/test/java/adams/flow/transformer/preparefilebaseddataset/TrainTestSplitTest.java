...
public class TrainTestSplitTest
   ...
   */
  public TrainTestSplitTest(String name) {
    super(name);
  }
  ...
  protected AbstractFileBasedDatasetPreparation<String[]>[] getRegressionSetups() {
    ...
    result = new TrainTestSplit[3];
    result[0] = new TrainTestSplit();
    result[1] = new TrainTestSplit();
    result[1].setPreserveOrder(true);
    result[2] = new TrainTestSplit();
  ...
  public static Test suite() {
    return new TestSuite(TrainTestSplitTest.class);
  }
