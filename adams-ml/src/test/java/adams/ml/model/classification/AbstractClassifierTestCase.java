...
public abstract class AbstractClassifierTestCase
   ...
   * @return		the setups
   */
  protected abstract Classifier[] getRegressionSetups();
  ...
  /**
   * Trains the classifier and returns the predictions.
   *
   * @param cls		the classifier to use
   * @param data	the training data
   * @return		the predictions on the training data
   */
  protected double[][] predict(Classifier cls, Dataset data) {
    double[][]		result;
