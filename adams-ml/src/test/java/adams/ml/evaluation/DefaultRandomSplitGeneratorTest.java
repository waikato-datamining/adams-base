...
/**
 * Tests: DefaultRandomSplitGenerator
 *
 * @author fracpete (fracpete at waikato dot ac dot nz)
 */
public class DefaultRandomSplitGeneratorTest
  extends AbstractSplitGeneratorTestCase<DefaultRandomSplitGenerator> {
   ...
   */
  @Override
  protected DefaultRandomSplitGenerator getTypicalSetup() {
    return new DefaultRandomSplitGenerator();
  }
   ...
   */
  @Override
  protected DefaultRandomSplitGenerator[] getRegressionSetups() {
    DefaultRandomSplitGenerator[]	result;

    result    = new DefaultRandomSplitGenerator[3];

    result[0] = new DefaultRandomSplitGenerator();

    result[1] = new DefaultRandomSplitGenerator();
    result[1].setPreserveOrder(true);

    result[2] = new DefaultRandomSplitGenerator();
    result[2].setPercentage(0.5);
    result[2].setSeed(42);
