...
/*
 * MultiTargetClassificationModel.java
...
public interface MultiTargetClassificationModel
   ...
   * @return		the class label per class attribute
   * @throws Exception	if prediction fails
   */
  public Map<String,String> classify(Row row) throws Exception;

  /**
   * Returns the class distribution for the given row.
   *
   * @param row		the row to generate the class distribution for
   * @return		the class distribution per class attribute
   * @throws Exception	if prediction fails
   */
  public Map<String,double[]> distribution(Row row) throws Exception;
}
