...
import adams.data.splitgenerator.SplitGenerator;
...
public abstract class AbstractSplitGenerator
  ...
  implements SplitGenerator<Dataset,TrainTestSetContainer> {
   ...
   */
  protected abstract TrainTestSetContainer createNext();
   ...
   */
  @Override
  public synchronized TrainTestSetContainer next() {
    if (!m_Initialized)
      initializeIterator();
    return createNext();
  }
