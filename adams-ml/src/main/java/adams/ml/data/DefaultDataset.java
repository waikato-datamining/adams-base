...
public class DefaultDataset
  ...
  public void assign(SpreadSheet sheet) {
    ...
    if (sheet instanceof Dataset)
      m_ClassAttributes.addAll(Arrays.asList(((Dataset) sheet).getClassAttributeKeys()));
  }
  ...
  public Dataset getClone() {
    ...
    result = (DefaultDataset) super.getClone();
  ...
  public Dataset getHeader() {
    ...
    result = (DefaultDataset) super.getHeader();
    result.m_ClassAttributes.addAll(m_ClassAttributes);
  ...
  public void mergeWith(SpreadSheet other) {
    ...
    if (other instanceof DefaultDataset) {
      indices = ((DefaultDataset) other).getClassAttributeIndices();
      for (i = 0; i < indices.length; i++)
