 ...
 * &nbsp;&nbsp;&nbsp;Deletes the timeseries containers with the specified DB-IDs from the database.<br>
 * <br>
 * disconnect<br>
 ...
 * &nbsp;&nbsp;&nbsp;Adds the timeseries containers to the currently loaded ones.<br>
 * <br>
 * add-data-file &lt;spectrum-reader scheme&gt;<br>
 * &nbsp;&nbsp;&nbsp;Adds the spectrum loaded via the given reader to the currently loaded ones.<br>
 * <br>
 * clear-data<br>
 * &nbsp;&nbsp;&nbsp;Removes all timeseries containers.<br>
 * <br>
 * filter &lt;classname + options&gt;<br>
 * &nbsp;&nbsp;&nbsp;Executes the filter on the visible timeseries containers, replaces the original ones.<br>
 * <br>
 * filter-overlay &lt;classname + options&gt;<br>
 * &nbsp;&nbsp;&nbsp;Executes the filter on the visible timeseries containers, overlays the original ones.<br>
 * <br>
 * invisible &lt;comma-separated list of 1-based indices&gt;<br>
 * &nbsp;&nbsp;&nbsp;Sets the visibility of the specified timeseries containers to false.<br>
 * &nbsp;&nbsp;&nbsp;NB: index is based on the order the timeseries containers haven beeen loaded into the <br>
 * &nbsp;&nbsp;&nbsp;system, includes all timeseries containers, not just visible ones.<br>
 * <br>
 * remove-data &lt;comma-separated list of 1-based indices&gt;<br>
 * &nbsp;&nbsp;&nbsp;Removes the timeseries containers with the specified indices.<br>
 * &nbsp;&nbsp;&nbsp;NB: index is based on the order the timeseries containers haven beeen loaded into the <br>
 * &nbsp;&nbsp;&nbsp;system, includes all timeseries containers, not just visible ones.<br>
 * <br>
 ...
 * &nbsp;&nbsp;&nbsp;The processed timeseries containers replace the currently loaded ones.<br>
 * <br>
 * run-flow-overlay &lt;filename&gt;<br>
 * &nbsp;&nbsp;&nbsp;Executes the flow stored in the given file.<br>
 * &nbsp;&nbsp;&nbsp;The base actor has to be 'adams.flow.control.SubProcess'.<br>
 * &nbsp;&nbsp;&nbsp;The processed timeseries containers overlay the currently loaded ones.<br>
 * <br>
 ...
 * &nbsp;&nbsp;&nbsp;Sets the visibility of the specified timeseries containers to true.<br>
 * &nbsp;&nbsp;&nbsp;NB: index is based on the order the timeseries containers haven beeen loaded into the <br>
 * &nbsp;&nbsp;&nbsp;system, includes all timeseries containers, not just visible ones.<br>
 * <br>
