 ...
 * @version $Revision$
 */
public class TimeseriesSlidingWindowTest
   ...
   */
  public TimeseriesSlidingWindowTest(String name) {
    super(name);
  }
  ...
  protected AbstractSmoother[] getRegressionSetups() {
    TimeseriesSlidingWindow[]	result;

    result = new TimeseriesSlidingWindow[4];

    result[0] = new TimeseriesSlidingWindow();

    result[1] = new TimeseriesSlidingWindow();
    result[1].setMeasure(Measure.MEAN);

    result[2] = new TimeseriesSlidingWindow();
    result[2].setWindowSize(40);

    result[3] = new TimeseriesSlidingWindow();
  ...
  public static Test suite() {
    return new TestSuite(TimeseriesSlidingWindowTest.class);
  }
