...
/**
 * Test class for the TimeseriesChangeResolution filter. Run from the command line with: <br><br>
 * java adams.data.filter.TimeseriesChangeResolutionTest
 *
 * @author  fracpete (fracpete at waikato dot ac dot nz)
 * @version $Revision: 7892 $
 */
public class TimeseriesChangeResolutionTest
   ...
   */
  public TimeseriesChangeResolutionTest(String name) {
    super(name);
  }
  ...
  protected AbstractFilter[] getRegressionSetups() {
    ...
    result[0] = new TimeseriesChangeResolution();

    result[1] = new TimeseriesChangeResolution();
    result[1].setPolynomial(1);
    result[1].setInterval(30 * 60);

    result[2] = new TimeseriesChangeResolution();
    result[2].setPolynomial(3);
    result[1].setInterval(30 * 60);
