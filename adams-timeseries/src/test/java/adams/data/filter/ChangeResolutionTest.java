...
public class ChangeResolutionTest
   ...
   */
  public ChangeResolutionTest(String name) {
    super(name);
  }
  ...
  protected AbstractFilter[] getRegressionSetups() {
    ChangeResolution[]	result;

    result = new ChangeResolution[3];

    result[0] = new ChangeResolution();

    result[1] = new ChangeResolution();
    result[1].setPolynomial(1);
    result[1].setInterval(30 * 60);

    result[2] = new ChangeResolution();
