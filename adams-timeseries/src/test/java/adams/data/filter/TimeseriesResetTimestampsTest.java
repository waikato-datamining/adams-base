...
/**
 * Test class for the TimeseriesResetTimestamps filter. Run from the command line with: <br><br>
 * java adams.data.filter.TimeseriesResetTimestampsTest
 *
 * @author  fracpete (fracpete at waikato dot ac dot nz)
 * @version $Revision: 7892 $
 */
public class TimeseriesResetTimestampsTest
   ...
   */
  public TimeseriesResetTimestampsTest(String name) {
    super(name);
  }
  ...
  protected Filter[] getRegressionSetups() {
    ...
    result[0] = new TimeseriesResetTimestamps();

    result[1] = new TimeseriesResetTimestamps();
  ...
  public static Test suite() {
    return new TestSuite(TimeseriesResetTimestampsTest.class);
  }
