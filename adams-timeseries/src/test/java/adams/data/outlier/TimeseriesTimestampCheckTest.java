...
import adams.data.outlier.TimeseriesTimestampCheck.TimestampCondition;
 ...
 */
public class TimeseriesTimestampCheckTest
   ...
   */
  public TimeseriesTimestampCheckTest(String name) {
    super(name);
  }
  ...
  protected AbstractOutlierDetector[] getRegressionSetups() {
    TimeseriesTimestampCheck[]		result;
    
    result    = new TimeseriesTimestampCheck[3];
    
    result[0] = new TimeseriesTimestampCheck();
    
    result[1] = new TimeseriesTimestampCheck();
    ...
    result[2] = new TimeseriesTimestampCheck();
  ...
  public static Test suite() {
    return new TestSuite(TimeseriesTimestampCheckTest.class);
  }
