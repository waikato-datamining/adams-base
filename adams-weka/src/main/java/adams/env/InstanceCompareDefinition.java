...
/**
 * InstanceCompareDefinition.java
 ...
 * @version $Revision$
 */
public class InstanceCompareDefinition
  ...
  /** the key as constant. */
  public final static String KEY = "instance compare";
  ...
  public String getFile() {
    return InstanceComparePanel.FILENAME;
  }
  ...
  public void update(AbstractEnvironment env) {
    add(env, Project.NAME + "/gui/visualization/instance", new String[0]);
  }
}
