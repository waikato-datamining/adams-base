...
/**
 * Updates the debug flag of classes derived from {@link Filter}.
 *
 * @author fracpete (fracpete at waikato dot ac dot nz)
 */
public class WekaFilterDebugUpdater
  ...
  public String globalInfo() {
    return "Updates the debug flag of classes derived from " + Utils.classToString(Filter.class) + ".";
  }
  ...
  public boolean updateLoggingLevel(Object obj) {
    if (obj instanceof Filter) {
      ((Filter) obj).setDebug(m_NewDebugValue);
      return (((Filter) obj).getDebug() == m_NewDebugValue);
    }
    return false;
  }
}
