...
public abstract class AbstractWekaDebugUpdater
  ...
  private static final long serialVersionUID = -8425318854317406774L;
  ...
  public String newDebugValueTipText() {
    return "The new value to use for the debug flag.";
  }
}
