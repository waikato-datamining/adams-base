...
public class TextDirectoryLoaderContainer
  ...
  protected String doReload() {
    if (!m_Loader.getDirectory().exists())
      return "Directory does not exist: " + m_Loader.getDirectory();
    ...
    try {
      ...
      return handleException("Failed to regenerate data: " + OptionUtils.getCommandLine(m_Loader), e);
    }
  }
