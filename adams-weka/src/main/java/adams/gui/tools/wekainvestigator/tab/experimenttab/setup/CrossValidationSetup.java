 ...
 */
public class CrossValidationSetup
  ...
  protected void initGUI() {
    ...
    m_SpinnerFolds.setValue(props.getInteger("Experiment.NumFolds", 10));
  ...
  public ResultItem init(Classifier classifier) throws Exception {
    ...
    // set up exp
    m_Experiment = new CrossValidationExperiment();
    m_Experiment.setRuns((Integer) m_SpinnerRuns.getValue());
    m_Experiment.setFolds((Integer) m_SpinnerFolds.getValue());
    ...
    m_Experiment.setGenerator((CrossValidationFoldGenerator) m_GOEGenerator.getCurrent());
  ...
  protected void doExecute(Classifier classifier, ResultItem item) throws Exception {
    ...
    meta.add("Folds", m_SpinnerFolds.getValue());
