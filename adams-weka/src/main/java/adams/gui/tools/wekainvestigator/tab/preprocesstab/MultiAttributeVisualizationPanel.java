...
/*
 * MultiAttributeVisualizationPanel.java
 ...
 */
public class MultiAttributeVisualizationPanel
  extends BasePanel {
  ...
  protected List<AttributeVisualizationPanel> m_Panels;
  ...
  protected void update() {
    ...
    if (m_Panels.size() == 1) {
      ...
      for (AttributeVisualizationPanel panel: m_Panels) {
        title = "...";
