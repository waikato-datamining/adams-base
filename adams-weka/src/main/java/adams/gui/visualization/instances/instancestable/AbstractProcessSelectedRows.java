...
public abstract class AbstractProcessSelectedRows
   ...
   * @param actRows	the rows in the Instances
   ...
   */
  protected abstract boolean doProcessSelectedRows(InstancesTable table, Instances data, int[] actRows, int[] selRows);
  ...
  public boolean processSelectedRows(InstancesTable table, Instances data, int[] actRows, int[] selRows) {
    ...
    result = (error == null);
    if (result)
      result = doProcessSelectedRows(table, data, actRows, selRows);
    else
