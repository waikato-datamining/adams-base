 ...
 */
public class PLSNNSearchWithIndices
  extends PLSNNSearch
  implements NearestNeighbourSearchWithIndices {

  private static final long serialVersionUID = -1190031755352538956L;
  ...
  public String globalInfo() {
    return "PLSNNSearch with index support.";
  }
