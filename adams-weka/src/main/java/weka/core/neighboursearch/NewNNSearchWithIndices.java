 ...
 */
public class NewNNSearchWithIndices
  extends NewNNSearch
  implements NearestNeighbourSearchWithIndices {

  private static final long serialVersionUID = 8418055082125959809L;
  ...
  public String globalInfo() {
    return "NewNNSearch with index support.";
  }
