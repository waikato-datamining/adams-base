 ...
 */
public class PCANNSearchWithIndices
  extends PCANNSearch
  implements NearestNeighbourSearchWithIndices {

  private static final long serialVersionUID = -1506570073632153605L;
  ...
  public String globalInfo() {
    return "PCANNSearch with index support.";
  }
