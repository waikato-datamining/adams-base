...
public class PLSClassifierWeighted
  extends AbstractClassifier implements WeightedInstancesHandler{

  /** for serialization */
  private static final long serialVersionUID = 4819775160590973256L;

  /** the PLS filter */
  protected PLSFilter m_Filter = getDefaultFilter();
  ...
  public Enumeration listOptions() {
	...
	+ "\t(default: " + getDefaultFilter().getClass().getName() + ")",
  ...
  public static void main(String[] args) {
    runClassifier(new PLSClassifierWeighted(), args);
  }
}
