...
public class Rule2
   ...
   */
  private RuleNode2[] m_internalNodes;
  ...
  public void buildClassifier(Instances data) throws Exception {
    ...
    m_globalStdDev = Rule2.stdDev(m_classIndex, m_instances);
    m_globalAbsDev = Rule2.absDev(m_classIndex, m_instances);

    m_topOfTree = new RuleNode2(m_globalStdDev, m_globalAbsDev, null);
  ...
  private void makeRule() throws Exception {
    RuleNode2[] best_leaf = new RuleNode2[1];
    ...
    if (m_smoothPredictions) {
      m_internalNodes = new RuleNode2[count];
    }
