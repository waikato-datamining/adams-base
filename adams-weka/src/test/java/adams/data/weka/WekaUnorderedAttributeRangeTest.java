...
/*
 * WekaUnorderedAttributeRangeTest.java
...
/**
 * Tests the adams.core.WekaUnorderedAttributeRange class. Run from commandline with: <br><br>
 * java adams.core.WekaUnorderedAttributeRangeTest
 * 
...
public class WekaUnorderedAttributeRangeTest
  ...
  public void testColumnNames() {
    ...
    range = new WekaUnorderedAttributeRange(Range.ALL);
    ...
    assertEquals("should be same", "class,duration", range.getRange());
    assertEqualsArrays("should be the same", new int[]{16,0}, range.getIntIndices());
