...
/**
 * Test class for the InstanceReader data container reader. Run from the command line with: <p/>
...
public class InstanceReaderTest
   ...
   */
  public InstanceReaderTest(String name) {
    super(name);
  }
  ...
  public static Test suite() {
    return new TestSuite(InstanceReaderTest.class);
  }
