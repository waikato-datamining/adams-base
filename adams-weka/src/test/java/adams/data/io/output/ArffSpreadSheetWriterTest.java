...
/*
 * ArffSpreadSheetWriterTest.java
...
/**
 * Tests the adams.data.io.input.ArffSpreadSheetWriter class. Run from commandline with: <br><br>
 * java adams.data.io.input.ArffSpreadSheetWriter
 *
 * @author  fracpete (fracpete at waikato dot ac dot nz)
 * @version $Revision$
 */
public class ArffSpreadSheetWriterTest
   ...
   */
  public ArffSpreadSheetWriterTest(String name) {
    super(name);
  }
