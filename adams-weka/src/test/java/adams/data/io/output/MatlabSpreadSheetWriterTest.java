...
/*
 * MatlabSpreadSheetWriterTest.java
...
/**
 * Tests the adams.data.io.input.MatlabSpreadSheetWriter class. Run from commandline with: <br><br>
 * java adams.data.io.input.MatlabSpreadSheetWriter
 *
 * @author  fracpete (fracpete at waikato dot ac dot nz)
 * @version $Revision$
 */
public class MatlabSpreadSheetWriterTest
   ...
   */
  public MatlabSpreadSheetWriterTest(String name) {
    super(name);
  }
  ...
  public static Test suite() {
    return new TestSuite(MatlabSpreadSheetWriterTest.class);
  }
