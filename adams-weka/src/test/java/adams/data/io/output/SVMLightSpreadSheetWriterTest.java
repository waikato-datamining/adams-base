...
/*
 * SVMLightSpreadSheetWriterTest.java
...
/**
 * Tests the adams.data.io.input.SVMLightSpreadSheetWriter class. Run from commandline with: <br><br>
 * java adams.data.io.input.SVMLightSpreadSheetWriter
 *
 * @author  fracpete (fracpete at waikato dot ac dot nz)
 * @version $Revision$
 */
public class SVMLightSpreadSheetWriterTest
   ...
   */
  public SVMLightSpreadSheetWriterTest(String name) {
    super(name);
  }
  ...
  public static Test suite() {
    return new TestSuite(SVMLightSpreadSheetWriterTest.class);
  }
