...
/*
 * WekaEvaluationValuePickerTest.java
...
/**
 * Tests the WekaEvaluationValuePicker actor.
 *
 * @author  fracpete (fracpete at waikato dot ac dot nz)
 * @version $Revision$
 */
public class WekaEvaluationValuePickerTest
   ...
   */
  public WekaEvaluationValuePickerTest(String name) {
    super(name);
  }
  ...
  public AbstractActor getActor() {
    ...
    WekaEvaluationValuePicker eval = new WekaEvaluationValuePicker();
    eval.setStatisticValue(EvaluationStatistic.AREA_UNDER_ROC);
    ...
    Flow flow = new Flow();
    flow.setActors(new AbstractActor[]{ga, sc, fr, cs, cv, eval, df});
  ...
  public static Test suite() {
    return new TestSuite(WekaEvaluationValuePickerTest.class);
  }
