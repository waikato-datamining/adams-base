...
/**
 * Tests the WekaTrainClassifier actor.
 *
 * @author  fracpete (fracpete at waikato dot ac dot nz)
 * @version $Revision$
 */
public class WekaTrainClassifierTest
   ...
   */
  public WekaTrainClassifierTest(String name) {
    super(name);
  }
  ...
  public AbstractActor getActor() {
    ...
    Flow flow = new Flow();
    flow.setActors(new AbstractActor[]{ga, sfs, fr, cs, wtc, df});
  ...
  public static Test suite() {
    return new TestSuite(WekaTrainClassifierTest.class);
  }
