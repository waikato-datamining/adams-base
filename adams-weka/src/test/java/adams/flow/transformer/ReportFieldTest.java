...
public class ReportFieldTest
  ...
  public AbstractActor getActor() {
    ...
    ib.setOperation(Operation.INSTANCES_TO_INSTANCE);
    ...
    Flow flow = new Flow();
    flow.setActors(new AbstractActor[]{sfs, fr, cs, wf, ib, ci, rf, df});
