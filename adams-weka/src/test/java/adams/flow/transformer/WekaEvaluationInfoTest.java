...
import adams.flow.transformer.WekaEvaluationInfo.InfoType;
...
/**
 * Test for WekaEvaluationInfo actor.
 *
 * @author fracpete
...
public class WekaEvaluationInfoTest
  ...
  public AbstractActor getActor() {
    ...
    try {
      ...
      wekaevaluationinfo.setType((InfoType) argOption.valueOf("NUM_PREDICTIONS"));
