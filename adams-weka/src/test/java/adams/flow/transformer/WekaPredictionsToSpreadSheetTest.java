...
/*
 * WekaPredictionsToSpreadSheetTest.java
...
/**
 * Tests the WekaPredictionsToSpreadSheet actor.
 *
 * @author  fracpete (fracpete at waikato dot ac dot nz)
 * @version $Revision$
 */
public class WekaPredictionsToSpreadSheetTest
   ...
   */
  public WekaPredictionsToSpreadSheetTest(String name) {
    super(name);
  }
  ...
  public AbstractActor getActor() {
    ...
    Flow flow = new Flow();
    flow.setActors(new AbstractActor[]{ga, sfs, fr, cs, cv, p2i, df});
  ...
  public static Test suite() {
    return new TestSuite(WekaPredictionsToSpreadSheetTest.class);
  }
