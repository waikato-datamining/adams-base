...
/*
 * WekaAttributeSelectionSummaryTest.java
...
/**
 * Test for WekaAttributeSelectionSummary actor.
 *
 * @author fracpete
 * @author adams.core.option.FlowJUnitTestProducer (code generator)
 * @version $Revision$
 */
public class WekaAttributeSelectionSummaryTest
   ...
   */
  public WekaAttributeSelectionSummaryTest(String name) {
    super(name);
  }
  ...
  public static Test suite() {
    return new TestSuite(WekaAttributeSelectionSummaryTest.class);
  }
  ...
  public AbstractActor getActor() {
    ...
    try {
      ...
      tmp1[3] = tmp8;
      // Flow.WekaAttributeSelectionSummary
      adams.flow.transformer.WekaAttributeSelectionSummary tmp14 = new adams.flow.transformer.WekaAttributeSelectionSummary();
      tmp1[4] = tmp14;
      // Flow.DumpFile
