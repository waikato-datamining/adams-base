...
/**
 * Tests the WekaClustering actor.
 *
...
public class WekaClusteringTest
   ...
   */
  public WekaClusteringTest(String name) {
    super(name);
  }
  ...
  protected void setUp() throws Exception {
    ...
    m_TestHelper.copyResourceToTmp("simplekmeans.model");
  ...
  protected void tearDown() throws Exception {
    ...
    m_TestHelper.deleteFileFromTmp("simplekmeans.model");
    m_TestHelper.deleteFileFromTmp("dumpfile.txt");
  ...
  public AbstractActor getActor() {
    ...
    WekaClustering cls = new WekaClustering();
    cls.setModelFile(new TmpFile("simplekmeans.model"));
    ...
    Flow flow = new Flow();
    flow.setActors(new AbstractActor[]{sfs, fr, cs, cls, cvp});
  ...
  public static Test suite() {
    return new TestSuite(WekaClusteringTest.class);
  }
