...
/*
 * WekaSetInstancesValueTest.java
...
/**
 * Test for WekaSetInstancesValue actor.
 *
 * @author fracpete
 * @author adams.core.option.FlowJUnitTestProducer (code generator)
 * @version $Revision$
 */
public class WekaSetInstancesValueTest
   ...
   */
  public WekaSetInstancesValueTest(String name) {
    super(name);
  }
  ...
  public static Test suite() {
    return new TestSuite(WekaSetInstancesValueTest.class);
  }
  ...
  public AbstractActor getActor() {
    ...
    try {
      ...
      // Flow.WekaSetInstancesValue
      adams.flow.transformer.WekaSetInstancesValue wekasetinstancesvalue7 = new adams.flow.transformer.WekaSetInstancesValue();
      argOption = (AbstractArgumentOption) wekasetinstancesvalue7.getOptionManager().findByProperty("row");
      wekasetinstancesvalue7.setRow((adams.core.Index) argOption.valueOf("5"));
      argOption = (AbstractArgumentOption) wekasetinstancesvalue7.getOptionManager().findByProperty("column");
      wekasetinstancesvalue7.setColumn((adams.data.weka.WekaAttributeIndex) argOption.valueOf("petallength"));
      argOption = (AbstractArgumentOption) wekasetinstancesvalue7.getOptionManager().findByProperty("value");
      wekasetinstancesvalue7.setValue((java.lang.String) argOption.valueOf("99"));
      actors1[2] = wekasetinstancesvalue7;
