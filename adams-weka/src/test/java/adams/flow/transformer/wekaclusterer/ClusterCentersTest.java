...
/**
 * Test for ClusterCenters post-processor.
 *
 * @author fracpete (fracpete at waikato dot ac dot nz)
 * @author adams.core.option.FlowJUnitTestProducer (code generator)
 * @version $Revision$
 */
public class ClusterCentersTest
   ...
   */
  public ClusterCentersTest(String name) {
    super(name);
  }
  ...
  public static Test suite() {
    return new TestSuite(ClusterCentersTest.class);
  }
