...
/*
 * WekaCrossValidationEvaluatorTest.java
...
/**
 * Tests the WekaCrossValidationEvaluator actor.
 *
 * @author  fracpete (fracpete at waikato dot ac dot nz)
 * @version $Revision$
 */
public class WekaCrossValidationEvaluatorTest
   ...
   */
  public WekaCrossValidationEvaluatorTest(String name) {
    super(name);
  }
  ...
  public Actor getActor() {
    ...
    Flow flow = new Flow();
    flow.setActors(new Actor[]{ga, sfs, fr, cs, cv, eval, df});
  ...
  public static Test suite() {
    return new TestSuite(WekaCrossValidationEvaluatorTest.class);
  }
