...
/**
 * Tests the WekaROC actor.
 *
 * @author  fracpete (fracpete at waikato dot ac dot nz)
 * @version $Revision$
 */
public class WekaThresholdCurveTest
   ...
   */
  public WekaThresholdCurveTest(String name) {
    super(name);
  }
  ...
  public AbstractActor getActor() {
    ...
    WekaThresholdCurve cc = new WekaThresholdCurve();
  ...
  public static Test suite() {
    return new TestSuite(WekaThresholdCurveTest.class);
  }
