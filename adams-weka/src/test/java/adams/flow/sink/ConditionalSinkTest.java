...
/**
 * Tests the ConditionalSink actor.
 *
 * @author  fracpete (fracpete at waikato dot ac dot nz)
 * @version $Revision$
 */
public class ConditionalSinkTest
   ...
   */
  public ConditionalSinkTest(String name) {
    super(name);
  }
  ...
  public AbstractActor getActor() {
    ...
    ConditionalSink ce = new ConditionalSink();

    WekaEvaluationSummary eval = new WekaEvaluationSummary();
    DumpFile df = new DumpFile();
    df.setOutputFile(new TmpFile("dumpfile.txt"));
    FileExists fe = new FileExists();
    fe.setFile(new TmpFile("dumpfile.txt"));
    fe.setInvert(true);
    ConditionalSink csink = new ConditionalSink();
    csink.setCondition(fe);
    csink.setActor(df);
    Sequence seq = new Sequence();
    seq.setActors(new AbstractActor[]{eval, csink});

    Branch br = new Branch();
    br.setBranches(new AbstractActor[]{ce, seq});
