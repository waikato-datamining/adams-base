...
/**
 * Tests the InstantiatableSink actor.
 *
 * @author  fracpete (fracpete at waikato dot ac dot nz)
 * @version $Revision$
 */
public class InstantiatableSinkTest
   ...
   */
  public InstantiatableSinkTest(String name) {
    super(name);
  }
  ...
  public static Test suite() {
    return new TestSuite(InstantiatableSinkTest.class);
  }
