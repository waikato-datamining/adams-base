...
/**
 * Tests PartitionedMultiFilter2. Run from the command line with: <p/>
 * java weka.filters.unsupervised.attribute.PartitionedMultiFilter2Test
 *
 * @author FracPete (fracpete at waikato dot ac dot nz)
 * @version $Revision$
 */
public class PartitionedMultiFilter2Test
  extends AbstractAdamsFilterTest {
  
  public PartitionedMultiFilter2Test(String name) {
    super(name);  
  }
  ...
  /** Creates a default PartitionedMultiFilter2 */
  public Filter getFilter() {
    return new PartitionedMultiFilter2();
  }
  ...
  protected Instances applyFilter(Filter[] filters, Range[] ranges, boolean remove)
    ...
    PartitionedMultiFilter2	filter;
    Instances			result;
    
    filter = (PartitionedMultiFilter2) getFilter();
  ...
  public static Test suite() {
    return new TestSuite(PartitionedMultiFilter2Test.class);
  }
