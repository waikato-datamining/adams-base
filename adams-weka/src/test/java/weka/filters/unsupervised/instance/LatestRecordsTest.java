 ...
 * @version $Revision$
 */
public class LatestRecordsTest
   ...
   */
  public LatestRecordsTest(String name) {
    super(name);
  }
  ...
  protected void setUp() throws Exception {
    ...
    loader.setSource(ClassLoader.getSystemResource("weka/filters/data/LatestRecords.arff"));
  ...
  /**
   * Creates a default LatestRecords.
   *
   * @return		the default filter
   */
  public Filter getFilter() {
    return new LatestRecords();
  }
  ...
  public static Test suite() {
    return new TestSuite(LatestRecordsTest.class);
  }
