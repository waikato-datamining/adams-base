...
/**
 * Test class for the Threshold transformer. Run from the command line with: <br><br>
 * java adams.data.opencv.transformer.ThresholdTest
 *
...
public class ThresholdTest
  ...
  protected AbstractOpenCVTransformer[] getRegressionSetups() {
    ...
    result[1].setType(ThresholdType.THRESH_OTSU);
