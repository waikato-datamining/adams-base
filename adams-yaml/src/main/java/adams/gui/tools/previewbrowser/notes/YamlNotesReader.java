...
public class YamlNotesReader
  ...
  public String globalInfo() {
    return "Reads notes in YAML format.";
  }
  ...
  protected Map<String, String> doRead(PlaceholderFile file, MessageCollection errors) {
    ...
    try {
      ...
      data    = yaml.loadAs(breader, Map.class);
      result = new HashMap<>();
      dir    = new PlaceholderDirectory(file.getParentFile());
      for (String key: data.keySet())
	addIfFileExists(result, dir, key, data.get(key));
    }
    catch (Exception e) {
