...
/**
 * Tests the MapToYamlString conversion.
 *
 * @author  fracpete (fracpete at waikato dot ac dot nz)
 * @version $Revision$
 */
public class MapToYamlStringTest
   ...
   */
  public MapToYamlStringTest(String name) {
    super(name);
  }
