...
/**
 * Test class for the MersenneTwister random number generator filter. Run from the command line with: <br><br>
 * java adams.data.random.MersenneTwisterTest
 *
...
public class MersenneTwisterTest
  ...
  protected RandomNumberGenerator[] getRegressionSetups() {
    ...
    result[0] = new MersenneTwister();

    result[1] = new MersenneTwister();
    result[1].setSeed(42);

    result[2] = new MersenneTwister();
