 ...
 * @version $Revision$
 * @see Random#weibull(double, double)
 */
public class Weibull
  extends AbstractDistributionBasedRandomNumberGenerator<Double> {

  /** for serialization. */
  private static final long serialVersionUID = -5293500831111509312L;
  ...
  public String globalInfo() {
    return "Generates random numbers from a Weibull random variable with specified mean and standard deviation.";
  }
  ...
  protected Double doNext() {
    return m_Random.weibull(m_Mean, m_Stdev);
  }
}
