 ...
 * @version $Revision$
 * @see Random#normal(double, double)
 */
public class Normal
  extends AbstractDistributionBasedRandomNumberGenerator<Double> {

  /** for serialization. */
  private static final long serialVersionUID = -7377352755052747331L;
  ...
  public String globalInfo() {
    return "Generates random numbers from a normal distribution with specified mean and standard deviation.";
  }
  ...
  protected Double doNext() {
    return m_Random.normal(m_Mean, m_Stdev);
  }
}
