...
/**
 * Test for JAIReader actor.
 *
 * @author fracpete
 * @author adams.core.option.FlowJUnitTestProducer (code generator)
 * @version $Revision$
 */
public class JAIReaderTest
   ...
   */
  public JAIReaderTest(String name) {
    super(name);
  }
  ...
  public static Test suite() {
    return new TestSuite(JAIReaderTest.class);
  }
  ...
  public AbstractActor getActor() {
    ...
    try {
      ...
      tmp1[0] = tmp2;
      adams.flow.transformer.JAIReader tmp4 = new adams.flow.transformer.JAIReader();
      tmp1[1] = tmp4;
