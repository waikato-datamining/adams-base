...
/**
 * Test for ImageMagickReader actor.
 *
 * @author fracpete
 * @author adams.core.option.FlowJUnitTestProducer (code generator)
 * @version $Revision$
 */
public class ImageMagickReaderTest
   ...
   */
  public ImageMagickReaderTest(String name) {
    super(name);
  }
  ...
  public static Test suite() {
    return new TestSuite(ImageMagickReaderTest.class);
  }
