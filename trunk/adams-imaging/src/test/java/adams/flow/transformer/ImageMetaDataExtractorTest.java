...
/**
 * Test for ImageMetaDataExtractor actor.
 *
 * @author fracpete
...
public class ImageMetaDataExtractorTest
   ...
   */
  public ImageMetaDataExtractorTest(String name) {
    super(name);
  }
  ...
  public static Test suite() {
    return new TestSuite(ImageMetaDataExtractorTest.class);
  }
  ...
  public AbstractActor getActor() {
    ...
    try {
      ...
      placeholderfile3[0] = (adams.core.io.PlaceholderFile) argOption.valueOf("${TMP}/8726547192_1d08b00bdf_o-small.jpg");
      filesupplier2.setFiles(placeholderfile3);

      abstractactor1[0] = filesupplier2;

      // Flow.ImageMetaDataExtractor
      adams.flow.transformer.ImageMetaDataExtractor imagemetadata4 = new adams.flow.transformer.ImageMetaDataExtractor();
      abstractactor1[1] = imagemetadata4;
