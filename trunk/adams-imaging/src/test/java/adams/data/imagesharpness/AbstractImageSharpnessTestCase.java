...
/**
 * AbstractImageSharpnessTestCase.java
 ...
 */
public abstract class AbstractImageSharpnessTestCase
   ...
   */
  public AbstractImageSharpnessTestCase(String name) {
    super(name);
  }
  ...
  protected AbstractTestHelper newTestHelper() {
    return new TestHelper(this, "adams/data/imagesharpness/data");
  }
   ...
   */
  protected boolean process(BufferedImageContainer img, AbstractImageSharpness scheme) {
    return scheme.isSharp(img);
  }
   ...
   * @return		the setups
   */
  protected abstract AbstractImageSharpness[] getRegressionSetups();
