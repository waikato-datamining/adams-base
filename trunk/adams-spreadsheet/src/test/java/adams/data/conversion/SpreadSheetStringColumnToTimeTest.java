...
/**
 * SpreadSheetStringColumnToTimeTest.java
...
/**
 * Tests the SpreadSheetStringColumnToTime conversion.
 *
...
public class SpreadSheetStringColumnToTimeTest
  ...
  protected void setUp() throws Exception {
    ...
    m_TestHelper.copyResourceToTmp("time.csv");
  ...
  protected void tearDown() throws Exception {
    m_TestHelper.deleteFileFromTmp("time.csv");
    m_TestHelper.deleteFileFromTmp("dumpfile.txt");
  ...
  protected Conversion[] getRegressionSetups() {
    SpreadSheetStringColumnToTime[]	result;

    result    = new SpreadSheetStringColumnToTime[2];
