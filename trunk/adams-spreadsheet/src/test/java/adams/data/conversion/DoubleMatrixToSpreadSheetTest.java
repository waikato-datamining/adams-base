...
/**
 * DoubleMatrixToSpreadSheetTest.java
...
/**
 * Tests the DoubleMatrixToSpreadSheet conversion.
 *
...
public class DoubleMatrixToSpreadSheetTest
  ...
  protected Conversion[] getRegressionSetups() {
    DoubleMatrixToSpreadSheet[]	result;

    result = new DoubleMatrixToSpreadSheet[1];
    result[0] = new DoubleMatrixToSpreadSheet();
  ...
  public static Test suite() {
    return new TestSuite(DoubleMatrixToSpreadSheetTest.class);
  }
