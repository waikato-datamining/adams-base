...
/**
 * SpreadSheetStringColumnToDoubleTest.java
...
/**
 * Tests the SpreadSheetStringColumnToDouble conversion.
 *
 * @author  fracpete (fracpete at waikato dot ac dot nz)
 * @version $Revision$
 */
public class SpreadSheetStringColumnToDoubleTest
   ...
   */
  public SpreadSheetStringColumnToDoubleTest(String name) {
    super(name);
  }
  ...
  protected Conversion[] getRegressionSetups() {
    SpreadSheetStringColumnToDouble[]	result;

    result    = new SpreadSheetStringColumnToDouble[2];
    result[0] = new SpreadSheetStringColumnToDouble();
    result[0].setColumn(new SpreadSheetColumnIndex("2"));
    result[0].setFormat(new DecimalFormatString("#.#"));
    result[1] = new SpreadSheetStringColumnToDouble();
  ...
  public static Test suite() {
    return new TestSuite(SpreadSheetStringColumnToDoubleTest.class);
  }
