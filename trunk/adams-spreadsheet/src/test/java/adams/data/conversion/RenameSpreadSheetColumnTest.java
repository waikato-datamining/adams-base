...
/**
 * RenameSpreadSheetColumnTest.java
...
/**
 * Tests the RenameSpreadSheetColumn conversion.
 *
...
public class RenameSpreadSheetColumnTest
  ...
  protected Conversion[] getRegressionSetups() {
    RenameSpreadSheetColumn[]	result;

    result    = new RenameSpreadSheetColumn[2];
    result[0] = new RenameSpreadSheetColumn();
    result[1] = new RenameSpreadSheetColumn();
