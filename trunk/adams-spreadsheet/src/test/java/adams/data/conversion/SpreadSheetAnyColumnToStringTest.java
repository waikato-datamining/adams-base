...
/**
 * SpreadSheetAnyColumnToStringTest.java
...
/**
 * Tests the SpreadSheetAnyColumnToString conversion.
 *
...
public class SpreadSheetAnyColumnToStringTest
  ...
  protected Conversion[] getRegressionSetups() {
    SpreadSheetAnyColumnToString[]	result;

    result    = new SpreadSheetAnyColumnToString[2];
