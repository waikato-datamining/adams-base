...
/**
 * SpreadSheetStringColumnToLongTest.java
...
/**
 * Tests the SpreadSheetStringColumnToLong conversion.
 *
...
public class SpreadSheetStringColumnToLongTest
  ...
  protected Conversion[] getRegressionSetups() {
    SpreadSheetStringColumnToLong[]	result;

    result    = new SpreadSheetStringColumnToLong[2];
  ...
  public static Test suite() {
    return new TestSuite(SpreadSheetStringColumnToLongTest.class);
  }
