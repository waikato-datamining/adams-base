...
/*
 * SpreadSheetGetHeaderCellTest.java
...
/**
 * Test for SpreadSheetGetHeaderCell actor.
 *
 * @author fracpete
 * @author adams.core.option.FlowJUnitTestProducer (code generator)
 * @version $Revision$
 */
public class SpreadSheetGetHeaderCellTest
   ...
   */
  public SpreadSheetGetHeaderCellTest(String name) {
    super(name);
  }
  ...
  public static Test suite() {
    return new TestSuite(SpreadSheetGetHeaderCellTest.class);
  }
  ...
  public AbstractActor getActor() {
    ...
    try {
      ...
      // Flow.SpreadSheetGetHeaderCell
      adams.flow.transformer.SpreadSheetGetHeaderCell spreadsheetgetheadercell7 = new adams.flow.transformer.SpreadSheetGetHeaderCell();
      abstractactor1[2] = spreadsheetgetheadercell7;
