...
/**
 * Test class for the AddMetaData feature generator. Run from the command line with: <p/>
 * java adams.data.timeseries.flattener.AddMetaDataTest
 *
...
public class AddMetaDataTest
   ...
   */
  public AddMetaDataTest(String name) {
    super(name);
  }
  ...
  protected AbstractTimeseriesFeatureGenerator[] getRegressionSetups() {
    ...
    result = new AddMetaData[2];
    result[0] = new AddMetaData();
    result[1] = new AddMetaData();
    result[1].setAddDatabaseID(true);
    result[1].setAddID(true);
