...
public class SetStartTest
   ...
   */
  public SetStartTest(String name) {
    super(name);
  }
  ...
  protected AbstractFilter[] getRegressionSetups() {
    ...
    result = new SetStart[2];

    result[0] = new SetStart();
    result[0].setStart(new BaseDateTime(BaseDateTime.INF_PAST));

    result[1] = new SetStart();
  ...
  public static Test suite() {
    return new TestSuite(SetStartTest.class);
  }
