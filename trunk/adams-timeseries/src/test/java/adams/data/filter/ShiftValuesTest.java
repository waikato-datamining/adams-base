...
public class ShiftValuesTest
   ...
   */
  public ShiftValuesTest(String name) {
    super(name);
  }
  ...
  protected AbstractFilter[] getRegressionSetups() {
    ...
    result = new ShiftValues[3];

    result[0] = new ShiftValues();

    result[1] = new ShiftValues();
    result[1].setAmount(-1000);;

    result[2] = new ShiftValues();
  ...
  public static Test suite() {
    return new TestSuite(ShiftValuesTest.class);
  }
