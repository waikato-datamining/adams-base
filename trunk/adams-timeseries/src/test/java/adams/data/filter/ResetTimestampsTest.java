 ...
 */
public class ResetTimestampsTest
   ...
   */
  public ResetTimestampsTest(String name) {
    super(name);
  }
  ...
  protected AbstractFilter[] getRegressionSetups() {
    ResetTimestamps[]	result;

    result = new ResetTimestamps[2];

    result[0] = new ResetTimestamps();

    result[1] = new ResetTimestamps();
  ...
  public static Test suite() {
    return new TestSuite(ResetTimestampsTest.class);
  }
