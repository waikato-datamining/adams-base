...
public class TimedTriggerTest
   ...
   */
  public TimedTriggerTest(String name) {
    super(name);
  }
  ...
  public static Test suite() {
    return new TestSuite(TimedTriggerTest.class);
  }
  ...
  public AbstractActor getActor() {
    ...
    try {
      ...
      // Flow.TimedTrigger
      adams.flow.control.TimedTrigger timedtrigger8 = new adams.flow.control.TimedTrigger();
      argOption = (AbstractArgumentOption) timedtrigger8.getOptionManager().findByProperty("actors");
      adams.flow.core.AbstractActor[] actors9 = new adams.flow.core.AbstractActor[2];

      // Flow.TimedTrigger.Start
      adams.flow.source.Start start10 = new adams.flow.source.Start();
      actors9[0] = start10;

      // Flow.TimedTrigger.Sleep
      adams.flow.control.Sleep sleep11 = new adams.flow.control.Sleep();
      actors9[1] = sleep11;
      timedtrigger8.setActors(actors9);

      argOption = (AbstractArgumentOption) timedtrigger8.getOptionManager().findByProperty("callableName");
      timedtrigger8.setCallableName((adams.flow.core.CallableActorReference) argOption.valueOf("Display"));
      actors1[2] = timedtrigger8;
