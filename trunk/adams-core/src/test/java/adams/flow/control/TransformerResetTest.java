...
/**
 * Test for TransformerReset actor.
 *
 * @author fracpete
 * @author adams.core.option.FlowJUnitTestProducer (code generator)
 * @version $Revision$
 */
public class TransformerResetTest
   ...
   */
  public TransformerResetTest(String name) {
    super(name);
  }
  ...
  public static Test suite() {
    return new TestSuite(TransformerResetTest.class);
  }
  ...
  public AbstractActor getActor() {
    ...
    try {
      ...
      actors15[0] = count16;
      transformerreset14.setActors(actors15);

      argOption = (AbstractArgumentOption) transformerreset14.getOptionManager().findByProperty("variableName");
      transformerreset14.setVariableName((adams.core.VariableName) argOption.valueOf("reset"));
      actors1[3] = transformerreset14;
