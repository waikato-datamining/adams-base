 ...
 * @version $Revision$
 */
public class TimedSubProcessTest
   ...
   */
  public TimedSubProcessTest(String name) {
    super(name);
  }
  ...
  public static Test suite() {
    return new TestSuite(TimedSubProcessTest.class);
  }
  ...
  public AbstractActor getActor() {
    ...
    try {
      ...
      actors9[0] = sleep10;
      timedsubprocess8.setActors(actors9);

      argOption = (AbstractArgumentOption) timedsubprocess8.getOptionManager().findByProperty("callableName");
      timedsubprocess8.setCallableName((adams.flow.core.CallableActorReference) argOption.valueOf("Display"));
      actors1[2] = timedsubprocess8;
