...
/**
 * Tests the 'BooleanReportValue' boolean condition.
 * 
 * @author  fracpete (fracpete at waikato dot ac dot nz)
 * @version $Revision$
 */
public class BooleanReportValueTest
   ...
   */
  public BooleanReportValueTest(String name) {
    super(name);
  }
  ...
  protected AbstractBooleanCondition[] getRegressionSetups() {
    BooleanReportValue[]	result;
    
    result    = new BooleanReportValue[3];
    result[0] = new BooleanReportValue();
    result[1] = new BooleanReportValue();
    result[1].setField(new Field("key2", DataType.BOOLEAN));
    result[2] = new BooleanReportValue();
    result[2].setField(new Field("key3", DataType.BOOLEAN));
  ...
  public static Test suite() {
    return new TestSuite(BooleanReportValueTest.class);
  }
