...
/**
 * AdvancedScriptEditorTemplatesDefinition.java
 * Copyright (C) 2013-0214 University of Waikato, Hamilton, New Zealand
 */
package adams.env;

import adams.gui.goe.AbstractAdvancedScriptEditorWithTemplates;
 ...
 */
public class AdvancedScriptEditorTemplatesDefinition
  ...
  /** the key as constant. */
  public final static String KEY = "advanced script editor templates";
  ...
  public String getFile() {
    return AbstractAdvancedScriptEditorWithTemplates.FILENAME;
  }
