 ...
 * @version $Revision$
 */
public interface AutoStartSupporter
  extends Actor {

  /**
   * Sets whether this processor gets executed on start up.
   *
   * @param value 	true if to automatically start
   */
   ...
   *
   * @return 		true if to automatically start
   */
   ...
   */
  public String autoStartTipText();
}
