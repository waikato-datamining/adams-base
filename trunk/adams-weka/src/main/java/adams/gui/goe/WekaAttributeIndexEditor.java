...
/**
 * Editor for {@link WekaAttributeIndex} objects.
 * 
 * @author  fracpete (fracpete at waikato dot ac dot nz)
 * @version $Revision$
 */
public class WekaAttributeIndexEditor
  extends IndexEditor {
  ...
  public static String toString(AbstractOption option, Object object) {
    return ((WekaAttributeIndex) object).getIndex();
  }
   ...
   */
  @Override
  protected WekaAttributeIndex parse(String s) {
    WekaAttributeIndex	result;

    try {
      result = new WekaAttributeIndex(s, Integer.MAX_VALUE);
    }
    catch (Exception e) {
      e.printStackTrace();
      result = null;
