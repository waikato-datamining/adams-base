...
/**
 * Tests the WekaClassifierErrors actor.
 *
 * @author  fracpete (fracpete at waikato dot ac dot nz)
 * @version $Revision$
 */
public class WekaClassifierErrorsTest
   ...
   */
  public WekaClassifierErrorsTest(String name) {
    super(name);
  }
  ...
  public AbstractActor getActor() {
    ...
    WekaClassifierErrors ce = new WekaClassifierErrors();
  ...
  public static Test suite() {
    return new TestSuite(WekaClassifierErrorsTest.class);
  }
