...
/**
 * Tests the WekaTrainClusterer actor.
 *
 * @author  fracpete (fracpete at waikato dot ac dot nz)
 * @version $Revision$
 */
public class WekaTrainClustererTest
   ...
   */
  public WekaTrainClustererTest(String name) {
    super(name);
  }
  ...
  public AbstractActor getActor() {
    ...
    Flow flow = new Flow();
    flow.setActors(new AbstractActor[]{ga, sfs, fr, cl, df});
  ...
  public static Test suite() {
    return new TestSuite(WekaTrainClustererTest.class);
  }
