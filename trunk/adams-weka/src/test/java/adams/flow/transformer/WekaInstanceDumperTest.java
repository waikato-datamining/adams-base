...
/**
 * Tests the WekaInstanceDumper actor.
 *
 * @author  fracpete (fracpete at waikato dot ac dot nz)
 * @version $Revision$
 */
public class WekaInstanceDumperTest
   ...
   */
  public WekaInstanceDumperTest(String name) {
    super(name);
  }
  ...
  public static Test suite() {
    return new TestSuite(WekaInstanceDumperTest.class);
  }
