...
public class WekaClustererTest
  ...
  public AbstractActor getActor() {
    ...
    WekaClusterer cl = new WekaClusterer();
    cl.setClusterer(new weka.clusterers.SimpleKMeans());

    DumpFile df = new DumpFile();
    df.setOutputFile(new TmpFile("dumpfile.txt"));

    Flow flow = new Flow();
    flow.setActors(new AbstractActor[]{sfs, fr, cl, df});
