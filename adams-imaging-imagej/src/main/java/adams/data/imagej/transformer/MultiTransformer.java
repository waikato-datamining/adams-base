...
/**
 <!-- globalinfo-start -->
 * Applies the specified ImageJ transformers one after the other.
 * <br><br>
 <!-- globalinfo-end -->
 *
 <!-- options-start -->
 ...
 * </pre>
 * 
 * <pre>-transformer &lt;adams.data.imagej.transformer.AbstractImageJTransformer&gt; [-transformer ...] (property: transformers)
...
public class MultiTransformer
  ...
  public void defineOptions() {
    ...
    m_OptionManager.add(
	    ...
	    new AbstractImageJTransformer[0]);
  }
  ...
  protected ImagePlusContainer[] doTransform(ImagePlusContainer img) {
    List<ImagePlusContainer>	result;
    List<ImagePlusContainer>	input;
    int				i;
    
    result = new ArrayList<ImagePlusContainer>();
    result.add(img);
    input  = new ArrayList<ImagePlusContainer>();
	...
	getLogger().info("Transformer #" + (i+1) + "...");
      ...
      for (ImagePlusContainer cont: input)
