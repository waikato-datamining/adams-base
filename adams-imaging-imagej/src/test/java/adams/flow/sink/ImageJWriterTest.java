...
import adams.flow.sink.ImageJWriter.ImageType;
import adams.flow.source.FileSupplier;
import adams.flow.transformer.ImageJReader;
import adams.test.TmpFile;

/**
 * Tests the ImageJWriter actor.
 *
...
public class ImageJWriterTest
  ...
  public Actor getActor() {
    ...
    iw.setImageType(ImageType.AUTO);
    iw.setOutputFile(new TmpFile("adams_logo.jpg"));

    Flow flow = new Flow();
    flow.setActors(new Actor[]{sfs, ir, iw});
