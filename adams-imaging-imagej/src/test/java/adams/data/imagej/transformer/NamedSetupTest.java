...
/**
 * Test class for the NamedSetup transformer. Run from the command line with: <br><br>
 * java adams.data.imagej.transformer.NamedSetupTest
 *
...
public class NamedSetupTest
  ...
  protected AbstractImageJTransformer[] getRegressionSetups() {
    ...
    result[0].setSetup(new adams.core.NamedSetup("imagej_transformer_passthrough"));
