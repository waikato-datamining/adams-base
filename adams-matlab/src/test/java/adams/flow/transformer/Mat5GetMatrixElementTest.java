...
/**
 * Test for Mat5GetMatrixElement actor.
 *
 * @author fracpete
 * @author adams.core.option.FlowJUnitTestProducer (code generator)
 */
public class Mat5GetMatrixElementTest
   ...
   */
  public Mat5GetMatrixElementTest(String name) {
    super(name);
  }
  ...
  public static Test suite() {
    return new TestSuite(Mat5GetMatrixElementTest.class);
  }
