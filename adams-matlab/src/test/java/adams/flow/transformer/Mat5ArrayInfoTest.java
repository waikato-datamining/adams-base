...
import adams.flow.transformer.Mat5ArrayInfo.InfoType;
...
public class Mat5ArrayInfoTest
  ...
  public AbstractActor getActor() {
    ...
    try {
      ...
      argOption = (AbstractArgumentOption) mat5arrayinfo.getOptionManager().findByProperty("type");
      mat5arrayinfo.setType((InfoType) argOption.valueOf("ALL"));
