...
/**
 * Test for Mat5FileReader actor.
 *
 * @author fracpete
 * @author adams.core.option.FlowJUnitTestProducer (code generator)
 */
public class Mat5FileReaderTest
   ...
   */
  public Mat5FileReaderTest(String name) {
    super(name);
  }
  ...
  public static Test suite() {
    return new TestSuite(Mat5FileReaderTest.class);
  }
