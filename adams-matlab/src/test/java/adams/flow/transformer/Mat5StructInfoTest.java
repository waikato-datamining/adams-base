...
/**
 * Test for Mat5StructInfo actor.
 *
 * @author fracpete
 * @author adams.core.option.FlowJUnitTestProducer (code generator)
 */
public class Mat5StructInfoTest
   ...
   */
  public Mat5StructInfoTest(String name) {
    super(name);
  }
  ...
  public static Test suite() {
    return new TestSuite(Mat5StructInfoTest.class);
  }
