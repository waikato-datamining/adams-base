...
/**
 * Test for Mat5FileGetArray actor.
 *
 * @author fracpete
 * @author adams.core.option.FlowJUnitTestProducer (code generator)
 */
public class Mat5FileGetArrayTest
   ...
   */
  public Mat5FileGetArrayTest(String name) {
    super(name);
  }
  ...
  public static Test suite() {
    return new TestSuite(Mat5FileGetArrayTest.class);
  }
