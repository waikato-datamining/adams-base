...
/**
 * Test for NewMat5Matrix actor.
 *
 * @author fracpete
 * @author adams.core.option.FlowJUnitTestProducer (code generator)
 */
public class NewMat5MatrixTest
   ...
   */
  public NewMat5MatrixTest(String name) {
    super(name);
  }
  ...
  public static Test suite() {
    return new TestSuite(NewMat5MatrixTest.class);
  }
