...
/**
 <!-- globalinfo-start -->
 * Sets the specified element in the matrix passing through.<br>
 ...
 * &nbsp;&nbsp;&nbsp;The index of the single value to set.
 * &nbsp;&nbsp;&nbsp;default:
 * </pre>
 *
 ...
 * &nbsp;&nbsp;&nbsp;Specifies the type of the value being set.
 * &nbsp;&nbsp;&nbsp;default: DOUBLE
 * </pre>
 *
 * <pre>-value &lt;java.lang.String&gt; (property: value)
 * &nbsp;&nbsp;&nbsp;The value to set in the matrix; gets parsed automatically.
 * &nbsp;&nbsp;&nbsp;default:
 * </pre>
 *
 <!-- options-end -->
...
public class Mat5SetMatrixElement
  ...
  protected String doExecute() {
    ...
    if (result == null) {
      ...
      result = MatlabUtils.setElement(matrix, index, m_ElementType, m_Value);
      if (result == null)
