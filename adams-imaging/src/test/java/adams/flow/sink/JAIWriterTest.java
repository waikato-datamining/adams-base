...
/**
 * Test for JAIWriter actor.
 *
 * @author fracpete
 * @author adams.core.option.FlowJUnitTestProducer (code generator)
 * @version $Revision$
 */
public class JAIWriterTest
   ...
   */
  public JAIWriterTest(String name) {
    super(name);
  }
  ...
  public static Test suite() {
    return new TestSuite(JAIWriterTest.class);
  }
  ...
  public AbstractActor getActor() {
    ...
    try {
      ...
      tmp1[1] = tmp4;
      adams.flow.sink.JAIWriter tmp5 = new adams.flow.sink.JAIWriter();
