...
/**
 * Test for ImageMagickWriter actor.
 *
 * @author fracpete
 * @author adams.core.option.FlowJUnitTestProducer (code generator)
 * @version $Revision$
 */
public class ImageMagickWriterTest
   ...
   */
  public ImageMagickWriterTest(String name) {
    super(name);
  }
  ...
  public static Test suite() {
    return new TestSuite(ImageMagickWriterTest.class);
  }
  ...
  public AbstractActor getActor() {
    ...
    try {
      ...
      tmp1[1] = tmp4;
      adams.flow.sink.ImageMagickWriter tmp5 = new adams.flow.sink.ImageMagickWriter();
