...
/*
 * GetImageObjectIndicesTest.java
...
/**
 * Test for GetImageObjectIndices actor.
 *
 * @author fracpete
 * @author adams.core.option.FlowJUnitTestProducer (code generator)
 * @version $Revision$
 */
public class GetImageObjectIndicesTest
   ...
   */
  public GetImageObjectIndicesTest(String name) {
    super(name);
  }
  ...
  public static Test suite() {
    return new TestSuite(GetImageObjectIndicesTest.class);
  }
