...
import adams.flow.transformer.ImageObjectInfo.InfoType;
...
/**
 * Test for ImageObjectInfo actor.
 *
 * @author fracpete
 * @author adams.core.option.FlowJUnitTestProducer (code generator)
 * @version $Revision$
 */
public class ImageObjectInfoTest
   ...
   */
  public ImageObjectInfoTest(String name) {
    super(name);
  }
  ...
  public static Test suite() {
    return new TestSuite(ImageObjectInfoTest.class);
  }
  ...
  public AbstractActor getActor() {
    ...
    try {
      ...
      // Flow.ImageObjectInfo
      ImageObjectInfo imageobjectinfo = new ImageObjectInfo();
      argOption = (AbstractArgumentOption) imageobjectinfo.getOptionManager().findByProperty("index");
      imageobjectinfo.setIndex((String) argOption.valueOf("99"));
      argOption = (AbstractArgumentOption) imageobjectinfo.getOptionManager().findByProperty("type");
      imageobjectinfo.setType((InfoType) argOption.valueOf("RECTANGLE"));
      actors.add(imageobjectinfo);
