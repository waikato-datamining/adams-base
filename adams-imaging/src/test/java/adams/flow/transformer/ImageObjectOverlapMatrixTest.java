...
/*
 * ImageObjectOverlapMatrixTest.java
...
/**
 * Test for ImageObjectOverlapMatrix actor.
 *
 * @author habdelqa
 */
public class ImageObjectOverlapMatrixTest
   ...
   */
  public ImageObjectOverlapMatrixTest(String name) {
    super(name);
  }
  ...
  public static Test suite() {
    return new TestSuite(ImageObjectOverlapMatrixTest.class);
  }
  ...
  public AbstractActor getActor() {
    ...
    try {
      ...
      // Flow.Compare.ImageObjectOverlapMatrix
      ImageObjectOverlapMatrix imageobjectoverlap = new ImageObjectOverlapMatrix();
      imageobjectoverlap.setStorageName(new StorageName("pred"));
      imageobjectoverlap.setFinder(new AllFinder());
      AreaRatio ratio = new AreaRatio();
      ratio.setMinOverlapRatio(0.5);
      ratio.setLabelKey("type");
      ratio.setUseOtherObject(true);
      ratio.setAdditionalObject(true);
      ratio.setAverageRatio(true);
      actors3.add(imageobjectoverlap);
