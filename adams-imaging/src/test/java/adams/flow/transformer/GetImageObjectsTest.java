...
/**
 * Test for GetImageObjects actor.
 *
 * @author fracpete
 * @author adams.core.option.FlowJUnitTestProducer (code generator)
 * @version $Revision$
 */
public class GetImageObjectsTest
   ...
   */
  public GetImageObjectsTest(String name) {
    super(name);
  }
  ...
  public static Test suite() {
    return new TestSuite(GetImageObjectsTest.class);
  }
  ...
  public AbstractActor getActor() {
    ...
    try {
      ...
      // Flow.GetImageObjects
      GetImageObjects GetImageObjects = new GetImageObjects();
      GetImageObjects.setOutputArray(false);

      actors.add(GetImageObjects);
