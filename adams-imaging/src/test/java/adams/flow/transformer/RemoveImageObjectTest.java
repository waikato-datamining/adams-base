...
/**
 * Test for RemoveImageObject actor.
 *
 * @author fracpete
 * @author adams.core.option.FlowJUnitTestProducer (code generator)
 * @version $Revision$
 */
public class RemoveImageObjectTest
   ...
   */
  public RemoveImageObjectTest(String name) {
    super(name);
  }
  ...
  public static Test suite() {
    return new TestSuite(RemoveImageObjectTest.class);
  }
  ...
  public AbstractActor getActor() {
    ...
    try {
      ...
      // Flow.RemoveImageObject
      RemoveImageObject removeimageobject = new RemoveImageObject();
      argOption = (AbstractArgumentOption) removeimageobject.getOptionManager().findByProperty("index");
      removeimageobject.setIndex((String) argOption.valueOf("0099"));
      actors.add(removeimageobject);

      // Flow.GetImageObjectIndices
      GetImageObjectIndices getimageobjectindices = new GetImageObjectIndices();
      getimageobjectindices.setOutputArray(true);

      actors.add(getimageobjectindices);
