...
public class ImageMetaDataTest
   ...
   */
  public ImageMetaDataTest(String name) {
    super(name);
  }
  ...
  public static Test suite() {
    return new TestSuite(ImageMetaDataTest.class);
  }
  ...
  public Actor getActor() {
    ...
    try {
      ...
      // Flow.ImageMetaData
      adams.flow.transformer.ImageMetaData imagemetadata4 = new adams.flow.transformer.ImageMetaData();
