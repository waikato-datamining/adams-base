...
/**
 * Tests the BoofCVFlattener actor.
 *
 * @author  fracpete (fracpete at waikato dot ac dot nz)
 * @version $Revision$
 */
public class BoofCVFlattenerTest
   ...
   */
  public BoofCVFlattenerTest(String name) {
    super(name);
  }
  ...
  public AbstractActor getActor() {
    ...
    Flow flow = new Flow();
    flow.setActors(new AbstractActor[]{mfs, ir, trans, con, ifl, id});
  ...
  public static Test suite() {
    return new TestSuite(BoofCVFlattenerTest.class);
  }
