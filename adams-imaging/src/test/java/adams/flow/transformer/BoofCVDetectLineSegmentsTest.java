...
/**
 * Test for BoofCVDetectLineSegments actor.
 *
 * @author fracpete
...
public class BoofCVDetectLineSegmentsTest
   ...
   */
  public BoofCVDetectLineSegmentsTest(String name) {
    super(name);
  }
  ...
  public static Test suite() {
    return new TestSuite(BoofCVDetectLineSegmentsTest.class);
  }
  ...
  public AbstractActor getActor() {
    ...
    try {
      ...
      // Flow.BoofCVDetectLineSegments
      adams.flow.transformer.BoofCVDetectLineSegments boofcvdetectlines9 = new adams.flow.transformer.BoofCVDetectLineSegments();
