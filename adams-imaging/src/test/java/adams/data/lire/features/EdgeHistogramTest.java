...
/**
 * Test class for the EdgeHistogram feature generator. Run from the command line with: <br><br>
 * java adams.data.lire.features.EdgeHistogramTest
 *
...
public class EdgeHistogramTest
   ...
   */
  public EdgeHistogramTest(String name) {
    super(name);
  }
  ...
  protected AbstractBufferedImageFeatureGenerator[] getRegressionSetups() {
    EdgeHistogram[]	result;

    result = new EdgeHistogram[1];

    result[0] = new EdgeHistogram();
