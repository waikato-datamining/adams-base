...
/**
 * Test class for the JCD feature generator. Run from the command line with: <br><br>
 * java adams.data.lire.features.JCDTest
 *
...
public class JCDTest
  ...
  public static Test suite() {
    return new TestSuite(JCDTest.class);
  }
