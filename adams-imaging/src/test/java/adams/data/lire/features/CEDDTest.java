...
/**
 * Test class for the CEDD feature generator. Run from the command line with: <br><br>
 * java adams.data.lire.features.CEDDTest
 *
...
public class CEDDTest
  ...
  public static Test suite() {
    return new TestSuite(CEDDTest.class);
  }
