...
/**
 * Test class for the PHOG feature generator. Run from the command line with: <br><br>
 * java adams.data.lire.features.PHOGTest
 *
...
public class PHOGTest
  ...
  public static Test suite() {
    return new TestSuite(PHOGTest.class);
  }
