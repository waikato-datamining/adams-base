...
/**
 * Test class for the Tamura feature generator. Run from the command line with: <br><br>
 * java adams.data.lire.features.TamuraTest
 *
...
public class TamuraTest
  ...
  public static Test suite() {
    return new TestSuite(TamuraTest.class);
  }
