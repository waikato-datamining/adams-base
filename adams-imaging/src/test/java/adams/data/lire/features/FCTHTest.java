...
/**
 * Test class for the FCTH feature generator. Run from the command line with: <br><br>
 * java adams.data.lire.features.FCTHTest
 *
...
public class FCTHTest
  ...
  public static Test suite() {
    return new TestSuite(FCTHTest.class);
  }
