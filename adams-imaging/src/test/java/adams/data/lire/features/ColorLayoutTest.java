...
/**
 * Test class for the ColorLayout flattener. Run from the command line with: <p/>
...
public class ColorLayoutTest
   ...
   */
  public ColorLayoutTest(String name) {
    super(name);
  }
  ...
  protected AbstractBufferedImageFeatureGenerator[] getRegressionSetups() {
    ...
    result = new ColorLayout[1];

    result[0] = new ColorLayout();
  ...
  public static Test suite() {
    return new TestSuite(ColorLayoutTest.class);
  }
