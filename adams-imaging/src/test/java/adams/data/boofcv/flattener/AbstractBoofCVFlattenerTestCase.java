...
/**
 * AbstractBoofCVFlattenerTestCase.java
 ...
 * @version $Revision$
 */
public abstract class AbstractBoofCVFlattenerTestCase
   ...
   */
  public AbstractBoofCVFlattenerTestCase(String name) {
    super(name);
  }
  ...
  protected AbstractTestHelper newTestHelper() {
    return new TestHelper(this, "adams/data/boofcv/flattener/data");
  }
   ...
   */
  protected Instance[] process(BoofCVImageContainer img, AbstractBoofCVFlattener scheme) {
   ...
   * @return		the setups
   */
  protected abstract AbstractBoofCVFlattener[] getRegressionSetups();
  ...
  public void testRegression() {
    ...
    int				i;
    String[]			input;
    AbstractBoofCVFlattener[]	setups;
    String[]			output;
    TmpFile[]			outputFiles;
