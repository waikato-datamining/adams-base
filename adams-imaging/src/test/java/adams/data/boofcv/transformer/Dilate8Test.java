...
/**
 * Test class for the Dilate8 transformer. Run from the command line with: <br><br>
 * java adams.data.boofcv.transformer.Dilate8Test
 *
 * @author  fracpete (fracpete at waikato dot ac dot nz)
 * @version $Revision: 7449 $
 */
public class Dilate8Test
   ...
   */
  public Dilate8Test(String name) {
    super(name);
  }
