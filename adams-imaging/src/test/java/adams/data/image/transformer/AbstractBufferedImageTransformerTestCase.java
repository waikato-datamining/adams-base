...
public abstract class AbstractBufferedImageTransformerTestCase
   ...
   */
  public AbstractBufferedImageTransformerTestCase(String name) {
    super(name);
  }
  ...
  protected AbstractTestHelper newTestHelper() {
    return new TestHelper(this, "adams/data/image/transformer/data");
  }
   ...
   */
  protected BufferedImageContainer[] process(BufferedImageContainer img, AbstractBufferedImageTransformer scheme) {
  ...
  protected boolean save(BufferedImageContainer data, String filename) {
	...
	Utils.flatten(
	    Utils.breakUp(
		Utils.arrayToString(
		    BufferedImageHelper.getPixelRaster(data.getImage())), 
		80), 
	    "\n"));
    content.append("\n");
   ...
   * @return		the setups
   */
  protected abstract AbstractBufferedImageTransformer[] getRegressionSetups();
  ...
  public void testRegression() {
    ...
    BufferedImageContainer[]		processed;
    boolean				ok;
    String				regression;
    int					i;
    int					n;
    String[]				input;
    AbstractBufferedImageTransformer[]	setups;
    String[][]				output;
