...
/**
 * Ancestor for test cases tailored for JAI feature generators.
 *
 * @author  fracpete (fracpete at waikato dot ac dot nz)
 * @version $Revision: 7706 $
 */
public abstract class AbstractJAIFeatureGeneratorTestCase
   ...
   */
  public AbstractJAIFeatureGeneratorTestCase(String name) {
    super(name);
  }
