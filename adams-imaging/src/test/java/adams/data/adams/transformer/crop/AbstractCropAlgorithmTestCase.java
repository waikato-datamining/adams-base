...
/**
 * AbstractCropAlgorithmTestCase.java
...
/**
 * Ancestor for test cases tailored for adams crop algorithms.
 *
...
public abstract class AbstractCropAlgorithmTestCase
  ...
  protected AbstractTestHelper newTestHelper() {
    return new TestHelper(this, "adams/data/adams/transformer/crop/data");
  }
  ...
  protected BufferedImage load(String filename) {
    ...
    result   = BufferedImageHelper.read(new PlaceholderFile(fullName)).getImage();
   ...
   */
  protected BufferedImage process(BufferedImage img, AbstractCropAlgorithm scheme) {
