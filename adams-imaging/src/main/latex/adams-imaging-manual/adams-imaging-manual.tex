...
Since the JAI actors use \texttt{BufferedImageContainer}, the 
...
\textit{BufferedImageContainer} tokens, the \textit{BufferedImageFeatureGenerator} can be used to
...
have to use the \textit{ImageJFeatureGenerator} instead. This transformer also outputs
