...
\begin{tight_itemize}
	...
	outputs another image again.
	\item \texttt{transformer.UFRawReader} -- for reading any image file that
	ufraw supports (namely RAW files) and forwarding a \texttt{BufferedImageContainer} object.
