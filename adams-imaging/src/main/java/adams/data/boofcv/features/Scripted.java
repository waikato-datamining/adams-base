...
public class Scripted
  ...
  protected transient AbstractBoofCVFeatureGenerator m_FlattenerObject;
  ...
  protected String loadScriptObject() {
	...
	AbstractBoofCVFeatureGenerator.class, 
	m_ScriptFile, 
	m_ScriptOptions, 
  ...
  protected void checkImage(BoofCVImageContainer img) {
    ...
    m_FlattenerObject = (AbstractBoofCVFeatureGenerator) m_ScriptObject;
  }
