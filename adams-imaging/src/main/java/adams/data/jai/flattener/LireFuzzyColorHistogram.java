 ...
 */
public class LireFuzzyColorHistogram
  ...
  public String globalInfo() {
    return
        "Generates features using " + FuzzyColorHistogram.class.getName() + ".\n"
