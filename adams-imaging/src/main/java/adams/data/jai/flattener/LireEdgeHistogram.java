 ...
 */
public class LireEdgeHistogram
  extends AbstractJAIFlattener {

  /** for serialization. */
  private static final long serialVersionUID = 1874040272178953103L;
  ...
  public String globalInfo() {
    return
        "Generates features using " + EdgeHistogram.class.getName() + ".\n"
  ...
  public Instances createHeader(BufferedImageContainer img) {
    ...
    for (i = 0; i < histo.length; i++)
      atts.add(new Attribute("EdgeHistogram-" + (i+1)));
