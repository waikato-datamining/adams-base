 ...
 */
public class LireLuminanceLayout
  extends AbstractJAIFlattener {

  /** for serialization. */
  private static final long serialVersionUID = 4806318817749723974L;
  ...
  public String globalInfo() {
    return
        "Generates features using " + LuminanceLayout.class.getName() + ".\n"
