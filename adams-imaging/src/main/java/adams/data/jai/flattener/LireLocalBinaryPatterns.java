 ...
 */
public class LireLocalBinaryPatterns
  ...
  public String globalInfo() {
    return
        "Generates features using " + LocalBinaryPatterns.class.getName() + ".\n"
