...
public class Scripted
  ...
  protected transient AbstractJAIFlattener m_FlattenerObject;
  ...
  protected void checkImage(BufferedImageContainer img) {
    ...
    m_FlattenerObject = (AbstractJAIFlattener) m_ScriptObject;
  }
  ...
  public Instance[] doFlatten(BufferedImageContainer img) {
    return m_FlattenerObject.flatten(img);
  }
