...
/*
 * LireFuzzyOpponentHistogram.java
 ...
 */
public class LireFuzzyOpponentHistogram
  ...
  public String globalInfo() {
    return
        "Generates features using " + FuzzyOpponentHistogram.class.getName() + ".\n"
  ...
  public Instances createHeader(BufferedImageContainer img) {
    ...
    FuzzyOpponentHistogram	features;
    BufferedImage		image;
    double[]			histo;
    int				i;
