 ...
 */
public class LireScalableColor
  ...
  public String globalInfo() {
    return
        "Generates features using " + ScalableColor.class.getName() + ".\n"
