...
/*
 * LireBinaryPatternsPyramid.java
 ...
 */
public class LireBinaryPatternsPyramid
  extends AbstractJAIFlattener {

  /** for serialization. */
  private static final long serialVersionUID = -2251490712206916608L;
  ...
  public String globalInfo() {
    return
        "Generates features using " + BinaryPatternsPyramid.class.getName() + ".\n"
  ...
  public Instances createHeader(BufferedImageContainer img) {
    ...
    BinaryPatternsPyramid	features;
    BufferedImage		image;
    double[]			histo;
    int				i;
    ...
    for (i = 0; i < histo.length; i++)
      atts.add(new Attribute("BPP-" + (i+1)));
