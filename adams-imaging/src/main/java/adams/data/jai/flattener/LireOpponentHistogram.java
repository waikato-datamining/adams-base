 ...
 */
public class LireOpponentHistogram
  ...
  public String globalInfo() {
    return
        "Generates features using " + OpponentHistogram.class.getName() + ".\n"
