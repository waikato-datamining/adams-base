 ...
 */
public class LireJpegCoefficientHistogram
  extends AbstractJAIFlattener {

  /** for serialization. */
  private static final long serialVersionUID = 4435917199794986005L;
  ...
  public String globalInfo() {
    return
        "Generates features using " + JpegCoefficientHistogram.class.getName() + ".\n"
  ...
  public Instances createHeader(BufferedImageContainer img) {
    ...
    JpegCoefficientHistogram	features;
    BufferedImage		image;
    double[]			histo;
    int				i;
    ...
    for (i = 0; i < histo.length; i++)
      atts.add(new Attribute("JpegCoefficientHistogram-" + (i+1)));
