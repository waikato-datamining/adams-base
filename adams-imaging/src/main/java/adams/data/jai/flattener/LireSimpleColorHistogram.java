 ...
 */
public class LireSimpleColorHistogram
  ...
  public String globalInfo() {
    return
        "Generates features using " + SimpleColorHistogram.class.getName() + ".\n"
