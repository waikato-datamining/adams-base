...
/*
 * LireRotationInvariantLocalBinaryPatterns.java
 ...
 */
public class LireRotationInvariantLocalBinaryPatterns
  ...
  public String globalInfo() {
    return
        "Generates features using " + RotationInvariantLocalBinaryPatterns.class.getName() + ".\n"
  ...
  public Instances createHeader(BufferedImageContainer img) {
    ...
    RotationInvariantLocalBinaryPatterns	features;
    BufferedImage				image;
    double[]					histo;
    int						i;

    image    = BufferedImageHelper.convert(img.getImage(), BufferedImage.TYPE_3BYTE_BGR);
    features = new RotationInvariantLocalBinaryPatterns();
