...
public class NamedSetup
  ...
  /** the actual scheme. */
  protected AbstractImageJFeatureGenerator m_ActualScheme;
  ...
  public String globalInfo() {
    return "Applies an ImageJ feature generator that is referenced via its global setup name (see 'NamedSetups').";
  }
   ...
   */
  protected AbstractImageJFeatureGenerator getActualScheme() {
    if (m_ActualScheme == null) {
      m_ActualScheme = (AbstractImageJFeatureGenerator) m_Setup.getSetup();
      if (m_ActualScheme == null)
