 ...
 */
public class AnyImageToByteArray
  ...
  public String globalInfo() {
    return "Turns any image container into a byte array.";
  }
  ...
  protected BufferedImage toBufferedImage(Object input) {
    return ((AbstractImageContainer) input).toBufferedImage();
  }
}
