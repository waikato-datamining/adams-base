...
/**
 <!-- globalinfo-start -->
 * Generates features using net.semanticmetadata.lire.imageanalysis.features.global.centrist.SpatialPyramidCentrist.<br>
 * For more information, see:<br>
 * Jianxin Wu; Rehg, J.M. (2011). CENTRIST: A Visual Descriptor for Scene Categorization. Pattern Analysis and Machine Intelligence.:1489-1501.<br>
 * <br>
 ...
 * <pre>
 * &#64;article{JianxinWu;Rehg2011,
 *    author = {Jianxin Wu; Rehg, J.M.},
 *    journal = {Pattern Analysis and Machine Intelligence},
 *    pages = {1489-1501},
 *    title = {CENTRIST: A Visual Descriptor for Scene Categorization},
 *    year = {2011},
 *    HTTP = {http:&#47;&#47;ieeexplore.ieee.org&#47;stamp&#47;stamp.jsp?tp=&amp;arnumber=5674051&amp;isnumber=5898466&#47;}
 * }
 * 
...
public class SpatialPyramidCentrist
  ...
  public String globalInfo() {
    return
        "Generates features using " + net.semanticmetadata.lire.imageanalysis.features.global.centrist.SpatialPyramidCentrist.class.getName() + ".\n"
  ...
  public TechnicalInformation getTechnicalInformation() {
    ...
    result.setValue(Field.AUTHOR, "Jianxin Wu; Rehg, J.M.");
    result.setValue(Field.TITLE, "CENTRIST: A Visual Descriptor for Scene Categorization");
    result.setValue(Field.JOURNAL, "Pattern Analysis and Machine Intelligence");
    result.setValue(Field.YEAR, "2011");
    result.setValue(Field.PAGES, "1489-1501");
    result.setValue(Field.HTTP, "http://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=5674051&isnumber=5898466/");
  ...
  public HeaderDefinition createHeader(BufferedImageContainer img) {
    ...
    double[]			histo;
    int				i;
    net.semanticmetadata.lire.imageanalysis.features.global.centrist.SpatialPyramidCentrist	features;

    image    = BufferedImageHelper.convert(img.getImage(), BufferedImage.TYPE_3BYTE_BGR);
    features = new net.semanticmetadata.lire.imageanalysis.features.global.centrist.SpatialPyramidCentrist();
