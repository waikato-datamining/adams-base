...
/**
 <!-- globalinfo-start -->
 * Splits the image into the specified separate HSV channels. With the output channels all converted to grayscale.
 * <br><br>
 <!-- globalinfo-end -->
 *
 <!-- options-start -->
 ...
 * </pre>
 * 
 * <pre>-channel &lt;H|S|V&gt; [-channel ...] (property: channels)
...
public class SplitChannelsHSV
  ...
  protected HSVChannel[] m_Channels;
   ...
   */
  public void setChannels(HSVChannel[] value) {
    m_Channels = value;
    reset();
  }
  ...
  protected BufferedImageContainer[] doTransform(BufferedImageContainer img) {
	...
	ColorUtils.convertRGBtoHSV(rgb, hsv);
        for (i = 0; i < m_Channels.length; i++) {
          switch (m_Channels[i]) {
	    case H:
              gray = (int) (hsv[0] * 255.0);
              break;
            case S:
              gray = (int) (hsv[1] * 255.0);
              break;
            case V:
              gray = (int) (hsv[2] * 255.0);
              break;
            default:
