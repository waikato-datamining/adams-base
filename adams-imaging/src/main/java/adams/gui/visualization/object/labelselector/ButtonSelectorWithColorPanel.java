...
/*
 * ButtonSelectorWithColorPanel.java
 ...
 */
public class ButtonSelectorWithColorPanel
   ...
   */
  public ButtonSelectorWithColorPanel(ObjectAnnotationPanel owner, BaseString[] labels, BaseColor[] colors) {
    super(owner);
  ...
  protected void initGUI() {
    ...
    for (i = 0; i < m_Labels.length; i++) {
      ...
      m_ButtonLabels[i] = new BaseToggleButton("<html>" + label + " <font color=\"" + m_Colors[i].toString() + "\">&diams;</font></html>");
