 ...
 */
public abstract class AbstractOutlinePlotter
    extends AbstractOptionHandler
    implements OutlinePlotter {
   ...
   */
  protected abstract void doPlotOutline(LocatedObject object, Color color, Graphics2D g);
