...
/**
 <!-- globalinfo-start -->
 * Computes the Intersect Over Union (IOU) of objects with the specified report from storage.<br>
 * It stores the highest IOU found (iou_highest) and the total number of iou greater than the specified minimum (iou_count).<br>
 ...
 * </pre>
 *
 * <pre>-min-iou-ratio &lt;double&gt; (property: minIntersectOverUnionRatio)
 * &nbsp;&nbsp;&nbsp;The minimum ratio that an iou must have before being considered an actual
 * &nbsp;&nbsp;&nbsp;overlap.
 * &nbsp;&nbsp;&nbsp;default: 0.0
 * &nbsp;&nbsp;&nbsp;minimum: 0.0
 * &nbsp;&nbsp;&nbsp;maximum: 1.0
 ...
 * &nbsp;&nbsp;&nbsp;value of the object with the highest iou gets stored in the report using
 * &nbsp;&nbsp;&nbsp;iou_label_highest, iou_label_highest_match stores whether the labels
 * &nbsp;&nbsp;&nbsp;match.
 * &nbsp;&nbsp;&nbsp;default:
 * </pre>
 *
...
public class IntersectOverUnion
  ...
  public String getQuickInfo() {
    ...
    result += QuickInfoHelper.toString(this, "minIntersectOverUnionRatio", m_MinIntersectOverUnionRatio, ", iou ratio: ");
