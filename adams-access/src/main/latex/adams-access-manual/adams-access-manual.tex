...
shows a screenshot of the viewer with a MS Access table loaded (\textbf{NB:} you need to tick
the \textit{Edit options} checkbox in the open dialog and enter the name of
the table to load).
